  ...
  "steps": [
    {
      ...
      "description": "A class should have only ONE reason to change. If a class handles both business logic and email sending, changes to email format force changes to the business class.",
        ...
        "items": [
          {
            "label": "UserService",
            "color": "#10b981",
            "value": "Only: save user → DB",
            "highlight": true
          },
          {
            "label": "WelcomeEmailService",
            "color": "#818cf8",
            "value": "Only: send welcome email"
          },
          {
            "label": "One reason to change each",
            "color": "#f59e0b",
            "value": "DB change? UserService. Email template? EmailService"
          }
        ]
      }
    },
    {
      ...
      "description": "Open for extension, closed for modification. Use interfaces and polymorphism to add new behaviour without changing existing code.",
      ...
      "diagram": {
        ...
        "steps": [
          {
            "label": "DiscountStrategy interface — closed for modification",
            "done": true
          },
          {
            "label": "SeasonalDiscount, LoyaltyDiscount — extensions",
            "done": true
          },
          {
            "label": "New discount: add class, touch nothing else",
            "active": true
          },
          {
    ...
    },
    {
      ...
      "description": "Subtypes must be substitutable for their base types without altering correctness. Violating LSP means your inheritance hierarchy is wrong.",
      ...
      "diagram": {
        ...
        "items": [
          {
            "label": "Can substitute subtype for base?",
            "color": "#10b981",
            "value": "If yes: LSP satisfied"
          },
          {
            "label": "Square IS-A Rectangle?",
            "color": "#ef4444",
            "value": "Geometrically yes, behaviourally NO",
            "highlight": true
          },
          {
            "label": "Fix: shared Shape interface",
            "color": "#818cf8",
            "value": "Rectangle and Square separate classes"
          }
        ]
      }
    },
    {
      ...
      "description": "ISP: clients should not depend on interfaces they don't use — split fat interfaces. DIP: depend on abstractions, not concretions.",
      ...
      "diagram": {
        ...
        "items": [
          {
            "label": "ISP: split fat interfaces",
            "color": "#10b981",
            "value": "Clients depend only on what they use",
            "highlight": true
          },
          {
            "label": "DIP: depend on interface",
            "color": "#818cf8",
            "value": "Not on concrete implementation"
          },
          {
            "label": "Constructor injection",
            "color": "#f59e0b",
            "value": "Makes dependencies explicit + testable"
          }
        ]
      }
    },
    {
      "title": "SOLID in a Spring Boot service",
      "description": "A well-designed Spring Boot service applies all 5 SOLID principles naturally through interfaces, DI, and layered architecture.",
      ...
      "diagram": {
        ...
        "steps": [
          {
            "label": "SRP: one class, one job",
            "done": true
          },
          {
            "label": "OCP: publish() in Topic entity — extend don't modify",
            "done": true
          },
          {
            "label": "DIP: repo + events are interfaces",
            "active": true
          },
          {
