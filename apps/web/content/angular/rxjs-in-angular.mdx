...
```json
{
  "steps": [
    {
      "title": "RxJS in Angular Services",
      "description": "Angular uses RxJS Observables throughout — HTTP, router, forms, and custom state.",
      ...
      "diagram": {
        ...
        "steps": [
          ...
          {
            "label": "filter >= 2 chars"
          },
          {
            "label": "switchMap → HTTP"
          },
          {
            "label": "results$ emits"
          }
    ...
    {
      "title": "async Pipe",
      "description": "The async pipe subscribes and unsubscribes automatically — prevents memory leaks.",
      ...
      "diagram": {
        ...
        "steps": [
          {
            "label": "users$ Observable"
          },
          {
            "label": "async pipe subscribes"
          },
          {
            "label": "Emits value"
          },
    ...
    },
    {
      ...
      "description": "takeUntilDestroyed replaces ngOnDestroy + unsubscribe boilerplate.",
      ...
      "diagram": {
        ...
        "steps": [
          {
            "label": "Subscribe in constructor"
          },
          {
    ...
    {
      "title": "combineLatest and forkJoin",
      "description": "Combine multiple observables — forkJoin for single emissions, combineLatest for continuous.",
      ...
      "diagram": {
        ...
        "items": [
          {
            "label": "combineLatest: any emits",
            "color": "#1e88e5"
          },
          {
            "label": "forkJoin: all complete",
            "color": "#43a047"
          },
          {
            "label": "zip: N-th together",
            "color": "#fb8c00"
          }
        ]
      }
    },
    {
      ...
      "diagram": {
        ...
        "items": [
          {
            "label": "Subject: no default",
            "color": "#9e9e9e"
          },
          {
            "label": "BehaviorSubject: has current",
            "color": "#1e88e5"
          },
          {
