  ...
  "steps": [
    {
      ...
      "description": "Module Federation enables sharing code between independently deployed Angular apps.",
      ...
      "diagram": {
        ...
        "steps": [
          ...
          {
            "label": "ProductApp (port 4201)"
          },
          {
            "label": "Load on demand"
          },
          {
            "label": "Shared @angular/core"
          }
        ]
      }
    },
    {
      "title": "Native Federation (ESM)",
      "description": "Native Federation uses browser-native ESM imports without webpack plugins.",
      "code": "// @angular-architects/native-federation\n// shell/federation.config.ts\nconst config: FederationConfig = {\n  name: 'shell',\n  remotes: {\n    mfe1: 'http://localhost:4201/remoteEntry.json',\n  },\n  shared: {\n    '@angular/core': { singleton: true, strictVersion: true }\n  }\n};\n\n// Load in shell\nconst routes: Routes = [\n  { path: 'products',\n    loadComponent: () => loadRemoteModule('mfe1', './Component')\n      .then(m => m.ProductsComponent)\n  }\n];",
      "highlight": [
        5,
        6,
        9,
      ...
      "diagram": {
        ...
        "steps": [
          ...
          {
            "label": "remoteEntry.json"
          },
          {
            "label": "MFE1 app remote"
          },
          {
            "label": "loadRemoteModule()"
          },
          {
            "label": "ESM import"
          }
    ...
    },
    {
      ...
      "diagram": {
        ...
        "steps": [
          {
            "label": "MFE1 emits event"
          },
          {
            "label": "EventBus / BroadcastChannel"
          },
          {
            "label": "MFE2 listens"
          },
    ...
    },
    {
      ...
      "diagram": {
        ...
        "steps": [
          ...
          {
            "label": "MFE1 owns /products/**"
          },
          {
            "label": "MFE2 owns /cart/**"
          },
          {
            "label": "loadRemoteModule()"
          },
