...
```json
{
  "steps": [
    ...
    },
    {
      ...
      "description": "Nx only runs tasks for projects affected by changes — massive CI time savings.",
      "code": "# Run only affected tests\nnx affected:test\n\n# Run only affected lint\nnx affected:lint\n\n# Run only affected builds\nnx affected:build\n\n# See what's affected by current changes\nnx affected:dep-graph\n\n# Set base for affected calculation\nnx affected:test --base=main --head=HEAD\n\n# Result: change in auth-lib → only runs auth + apps using auth",
      "highlight": [
        2,
        5,
        8,
      ...
      "diagram": {
        ...
        "steps": [
          ...
          {
            "label": "Only changed libs"
          },
          {
            "label": "Apps using them"
          },
          {
            "label": "Run tasks only for those"
          }
        ]
      }
    },
    {
      "title": "Project Boundary Rules",
      "description": "Enforce architecture rules with Nx module boundary lint rules.",
    ...
    },
    {
      ...
      "diagram": {
        ...
        "steps": [
          ...
          {
            "label": "Hash of inputs"
          },
          {
            "label": "Cache hit?"
          },
          {
            "label": "Restore instantly"
          },
          {
            "label": "OR compute + cache"
          }
        ]
      }
    },
    {
      "title": "Library Types and Tags",
      "description": "Tag libs by type and scope for enforced architecture.",
      "code": "// libs/feature-auth/project.json\n{\n  \"tags\": [\"type:feature\", \"scope:auth\"]\n}\n\n// libs/ui-components/project.json\n{\n  \"tags\": [\"type:ui\", \"scope:shared\"]\n}\n\n// libs/data-access-api/project.json\n{\n  \"tags\": [\"type:data-access\", \"scope:shared\"]\n}\n\n// Typical Nx library types:\n// feature: smart components, routes\n// ui: dumb/presentational components\n// data-access: services, state, API\n// util: pure functions, pipes, models",
      "highlight": [
        3,
        8,
        13,
