  ...
  "steps": [
    {
      ...
      "description": "@ViewChild queries one child; @ViewChildren queries all matching children.",
      ...
      "diagram": {
        ...
        "steps": [
          ...
          {
            "label": "AfterViewInit safe"
          },
          {
            "label": "Access DOM/component"
          },
          {
            "label": "@ViewChildren → QueryList"
          }
        ]
      }
    },
    {
      "title": "Signal-Based Queries (Angular 17+)",
      "description": "viewChild() and contentChild() provide signal-based alternatives to decorators.",
      "code": "import { viewChild, viewChildren, contentChild } from '@angular/core';\n\n@Component({\n  template: `\n    <input #input />\n    <app-item *ngFor=\"let i of items\" />\n  `\n})\nexport class ParentComponent {\n  input = viewChild.required<ElementRef>('input');\n  items = viewChildren(ItemComponent);\n\n  constructor() {\n    afterNextRender(() => {\n      // signal-based: input() gives ElementRef\n      this.input().nativeElement.focus();\n      this.items().forEach(i => i.refresh());\n    });\n  }\n}",
      "highlight": [
        10,
        11,
        15,
      ...
      "diagram": {
        ...
        "steps": [
          ...
          {
            "label": "Signal-based query"
          },
          {
            "label": "Reactive updates"
          },
          {
            "label": "Works with signals"
          },
          {
            "label": "No QueryList needed"
          }
        ]
      }
    },
    {
      "title": "@ContentChild",
      "description": "@ContentChild queries projected ng-content — used by wrapper/container components.",
      ...
      "diagram": {
        ...
        "steps": [
          {
            "label": "ng-content projected"
          },
          {
            "label": "AfterContentInit"
          },
          {
            "label": "@ContentChild resolves"
          },
          {
            "label": "@ContentChildren QueryList"
          },
          {
            "label": "Observe .changes$"
          }
        ]
      }
    },
    {
      "title": "QueryList and Changes Observable",
      "description": "QueryList.changes$ emits when child components are added or removed dynamically.",
      ...
      "diagram": {
        ...
        "steps": [
          {
            "label": "ContentChildren init"
          },
          {
            "label": "tabs QueryList"
          },
          {
            "label": "changes$ observable"
          },
          {
            "label": "Tab added/removed"
          },
          {
            "label": "Adjust activeIndex"
          }
        ]
      }
    },
    {
      "title": "Read Option",
      "description": "The read option of @ViewChild specifies what to read — ElementRef, ViewContainerRef, etc.",
      ...
      "diagram": {
        ...
        "steps": [
          {
            "label": "@ViewChild with read:"
          },
          {
            "label": "ElementRef → DOM"
          },
          {
            "label": "ViewContainerRef → host"
          },
          {
            "label": "TemplateRef → template"
          },
          {
