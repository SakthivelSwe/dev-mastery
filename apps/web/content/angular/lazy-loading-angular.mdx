  ...
  "steps": [
    {
      ...
      "description": "Lazy load entire route groups — main bundle shrinks, features load on demand.",
      ...
      "diagram": {
        ...
        "steps": [
          {
            "label": "app bundle: small"
          },
          {
            "label": "Navigate to /products"
          },
          {
            "label": "products.chunk.js loads"
          },
          {
            "label": "PRODUCT_ROUTES activated"
          },
          {
    ...
    },
    {
      ...
      "description": "Defer non-critical components until they become visible or needed.",
      "code": "// @defer block (Angular 17+)\n@Component({\n  template: `\n    <!-- Defer heavy component until user scrolls to it -->\n    @defer (on viewport) {\n      <analytics-chart [data]=\"data\" />\n    } @placeholder {\n      <div class=\"chart-placeholder\">Loading chart...</div>\n    } @loading (minimum 500ms) {\n      <spinner />\n    } @error {\n      <p>Chart failed to load</p>\n    }\n  `\n})\nexport class DashboardComponent {}",
      "highlight": [
        5,
        7,
        9,
    ...
    },
    {
      ...
      "diagram": {
        ...
        "steps": [
          {
            "label": "Build --stats-json"
          },
          {
            "label": "Bundle analyzer"
          },
          {
            "label": "Find large deps"
          },
          {
            "label": "Lazy load them"
          },
          {
            "label": "Budget alerts in CI"
          }
        ]
      }
    }
