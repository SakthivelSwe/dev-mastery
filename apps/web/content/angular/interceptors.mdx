  ...
  "steps": [
    {
      ...
      "description": "Angular 15+ functional interceptors are simpler than class-based.",
      ...
      "diagram": {
        ...
        "steps": [
          ...
          {
            "label": "Clone + add header"
          },
          {
            "label": "next(modifiedReq)"
          },
          {
            "label": "Server"
          }
    ...
    },
    {
      ...
      "description": "Centralized error handling — refresh tokens on 401, show error toasts.",
    ...
    },
    {
      ...
      "code": "export const retryInterceptor: HttpInterceptorFn = (req, next) => {\n  return next(req).pipe(\n    retryWhen(errors =>\n      errors.pipe(\n        // Only retry on 5xx server errors\n        mergeMap((error, attempt) => {\n          if (attempt >= 3 || error.status < 500) {\n            return throwError(() => error);\n          }\n          // Exponential backoff: 1s, 2s, 4s\n          const delay = Math.pow(2, attempt) * 1000;\n          return timer(delay);\n        })\n      )\n    )\n  );\n};",
      "highlight": [
        3,
        6,
        7,
      ...
      "diagram": {
        ...
        "steps": [
          ...
          {
            "label": "Attempt 1: wait 1s"
          },
          {
            "label": "Attempt 2: wait 2s"
          },
          {
            "label": "Attempt 3: wait 4s"
          },
          {
            "label": "Or fail permanently"
          }
        ]
      }
    }
