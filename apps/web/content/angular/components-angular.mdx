  ...
  "steps": [
    {
      ...
      "description": "@Input passes data down; @Output passes events up — the Angular communication pattern.",
      "code": "@Component({ standalone: true, selector: 'app-button', template:\n  `<button [class]=\"variant\" (click)=\"clicked.emit()\">{{ label }}</button>`\n})\nexport class ButtonComponent {\n  @Input({ required: true }) label!: string;\n  @Input() variant: 'primary' | 'danger' = 'primary';\n  @Output() clicked = new EventEmitter<void>();\n}\n\n// Parent\n<app-button\n  label=\"Save\"\n  variant=\"primary\"\n  (clicked)=\"onSave()\"\n/>",
      "highlight": [
        5,
        6,
        7,
      ...
      "diagram": {
        ...
        "steps": [
          ...
          {
            "label": "EventEmitter.emit()"
          },
          {
            "label": "Parent handler called"
          }
        ]
      }
    },
    ...
    },
    {
      ...
      "description": "ng-content allows parent to project HTML into component slots.",
      "code": "// Card component with slots\n@Component({\n  selector: 'app-card',\n  template: `\n    <div class=\"card\">\n      <div class=\"card-header\">\n        <ng-content select=\"[header]\"></ng-content>\n      </div>\n      <div class=\"card-body\">\n        <ng-content></ng-content>\n      </div>\n    </div>\n  `\n})\nexport class CardComponent {}\n\n// Usage\n<app-card>\n  <h2 header>Title</h2>\n  <p>Body content here</p>\n</app-card>",
      "highlight": [
        7,
        10,
        18,
    ...
    },
    {
      ...
      "description": "Angular components have a predictable lifecycle: create → check → update → destroy.",
