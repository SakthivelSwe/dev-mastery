...
{
  "language": "javascript",
  "fileName": "concurrent.jsx",
  "steps": [
    {
      "title": "Concurrent rendering",
      "description": "React 18 can interrupt renders. Urgent updates (typing) are not delayed by non-urgent ones (list filtering).",
      ...
      "diagram": {
        ...
        "items": [
          {
            "label": "automatic batching: even in timeouts/promises",
            "color": "#10b981",
            "highlight": true
          },
          {
            "label": "interruptible: urgent updates preempt slow",
            "color": "#10b981"
          },
          {
    ...
    {
      "title": "useTransition",
      "description": "Mark state update as non-urgent. React renders urgent updates first.",
      "code": "const [isPending, startTransition] = useTransition();\n\nfunction handleTabChange(tab) {\n    startTransition(() => {\n        setActiveTab(tab);  // non-urgent\n    });\n}\nreturn (\n    <>\n        <Tabs onChange={handleTabChange} />\n        {isPending ? <Spinner /> : <TabContent tab={activeTab} />}\n    </>\n);",
      "diagram": {
        "kind": "flow",
        "steps": [
          {
            "label": "user clicks tab: urgent UI update",
            "done": true
          },
          {
            "label": "startTransition: setActiveTab deferred",
            "done": true
          },
          {
            "label": "isPending: true while rendering content",
            "active": true
          },
          {
    ...
    },
    {
      ...
      "description": "Defer a value: UI renders with old value while computing new. Like debounce but React-native.",
      ...
      "diagram": {
        ...
        "items": [
          {
            "label": "input stays responsive with old results",
            "color": "#10b981",
            "highlight": true
          },
          {
            "label": "deferredQuery updates when React has time",
            "color": "#818cf8"
          },
          {
            "label": "isStale: fade while computing",
            "color": "#818cf8"
          }
        ]
      }
    ...
    {
      "title": "Suspense in concurrent mode",
      "description": "In concurrent mode, Suspense can show stale content while new content loads (startTransition + Suspense).",
      ...
      "diagram": {
        ...
        "steps": [
          {
            "label": "startTransition: setTab deferred",
            "done": true
          },
          {
            "label": "Suspense: keeps old content visible",
            "done": true
          },
          {
            "label": "new content ready: swap (no flash)",
            "active": true
          }
        ]
      }
    },
    {
      ...
      "description": "use(Promise) suspends until Promise resolves. use(Context) same as useContext.",
      ...
      "diagram": {
        ...
        "items": [
          {
            "label": "use(Promise): suspends during pending",
            "color": "#10b981",
            "highlight": true
          },
          {
            "label": "can be called conditionally",
            "color": "#10b981"
          },
          {
            "label": "use(Context): same as useContext",
            "color": "#818cf8"
          }
        ]
      }
