  ...
  "steps": [
    {
      ...
      "description": "useQuery for GET requests: automatic caching, background refetch, loading/error states.",
      ...
      "diagram": {
        ...
        "steps": [
          {
            "label": "useQuery: first mount → fetch",
            "done": true
          },
          {
            "label": "cache hit: instant data + background refetch",
            "done": true
          },
          {
            "label": "stale: refetch on window focus",
            "active": true
          },
          {
    ...
    {
      "title": "useMutation for writes",
      "description": "useMutation handles POST/PUT/DELETE. onSuccess/onError callbacks. Invalidate queries to refetch.",
      ...
      "diagram": {
        ...
        "messages": [
          ...
          },
          {
            "from": "useMutation",
            "to": "query cache",
            "label": "invalidate [\"users\"]"
          }
        ]
      }
    },
    {
      "title": "Query key design",
      "description": "Query keys are the cache keys. Array: [entity, params]. Invalidate by prefix.",
      ...
      "diagram": {
        ...
        "items": [
          {
            "label": "[\"users\"]: all users cache entries",
            "color": "#818cf8"
          },
          {
            "label": "[\"users\", id]: specific user",
            "color": "#818cf8"
          },
          {
            "label": "invalidate prefix: cascades to children",
            "color": "#10b981",
            "highlight": true
          }
        ]
    ...
    },
    {
      ...
      "description": "Update UI immediately, then sync to server. Rollback on error.",
      ...
      "diagram": {
        ...
        "steps": [
          {
            "label": "update UI immediately via setQueryData",
            "done": true
          },
          {
            "label": "mutation sent to server",
            "done": true
          },
          {
            "label": "error: rollback to prev",
            "active": true
          },
          {
    ...
    },
    {
      ...
      "description": "useInfiniteQuery for paginated lists or infinite scroll.",
      ...
      "diagram": {
        ...
        "steps": [
          {
            "label": "first page: pageParam=0",
            "done": true
          },
          {
            "label": "fetchNextPage: pageParam=nextCursor",
            "done": true
          },
          {
            "label": "data.pages: array of page results",
            "active": true
          },
          {
