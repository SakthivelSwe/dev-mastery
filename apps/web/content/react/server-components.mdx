  ...
  "steps": [
    {
      ...
      "description": "RSC run on the server, never in the browser. Can access DB, filesystem, secrets. Zero client JS bundle contribution.",
      ...
      "diagram": {
        ...
        "items": [
          {
            "label": "run on server: DB, FS, env secrets",
            "color": "#10b981",
            "highlight": true
          },
          {
            "label": "zero JS sent to browser",
            "color": "#10b981"
          },
          {
            "label": "no hooks: no useState/useEffect",
            "color": "#818cf8"
          }
        ]
      }
    },
    {
      ...
      "description": "\"use client\" marks a component as running in the browser. Can use hooks, browser APIs, event handlers.",
      ...
      "diagram": {
        ...
        "items": [
          {
            "label": "\"use client\": boundary → browser bundle",
            "color": "#818cf8"
          },
          {
            "label": "Server: data, auth, performance",
            "color": "#10b981",
            "highlight": true
          },
          {
            "label": "Client: interaction, animation, state",
            "color": "#818cf8"
          }
        ]
      }
    },
    {
      ...
      "description": "RSC + Suspense: server streams HTML progressively. Slow components render later without blocking faster ones.",
      "code": "// Next.js App Router\nfunction Page() {\n    return (\n        <div>\n            <StaticHeader />  {/* renders immediately */}\n            <Suspense fallback={<Skeleton />}>\n                <SlowUserData />  {/* streams when ready */}\n            </Suspense>\n            <Suspense fallback={<Skeleton />}>\n                <SlowPosts />  {/* independent stream */}\n            </Suspense>\n        </div>\n    );\n}",
      "diagram": {
        "kind": "flow",
        "steps": [
          {
            "label": "server: render StaticHeader immediately",
            "done": true
          },
          {
            "label": "stream HTML: SlowUserData + SlowPosts async",
            "done": true
          },
          {
            "label": "browser: show skeletons until streams arrive",
            "active": true
          },
          {
    ...
    },
    {
      ...
      "description": "Server Actions are functions that run on the server, called from client. Progressive enhancement for forms.",
        ...
        "messages": [
          {
            "from": "form",
            "to": "server",
            "label": "submit (POST) → Server Action"
          },
          {
            "from": "server",
            "to": "database",
            "label": "db.post.create(...)"
          },
          {
            "from": "server",
            "to": "form",
            "label": "revalidatePath → updated HTML"
          }
        ]
      }
    },
    {
      ...
      "description": "Pass server data as props to client components. Never pass secrets through client components.",
      ...
      "diagram": {
        "kind": "boxes",
        "title": "RSC + Client pattern",
        "items": [
          {
            "label": "Server: fetch all data at top",
            "color": "#10b981",
            "highlight": true
          },
          {
            "label": "pass to Client components as props",
            "color": "#818cf8"
          },
          {
            "label": "Client: only what needs interaction",
            "color": "#818cf8"
          }
        ]
      }
