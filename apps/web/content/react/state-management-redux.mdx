  ...
  "steps": [
    {
      ...
      "description": "Redux Toolkit (RTK) simplifies Redux. createSlice generates actions + reducers. configureStore sets up store.",
      ...
      "diagram": {
        ...
        "steps": [
          ...
          {
            "label": "reducer: state.value += 1 (via Immer)",
            "done": true
          },
          {
            "label": "new state: { value: 1 }",
            "active": true
          },
          {
    ...
    {
      "title": "RTK store and Provider",
      "description": "configureStore creates the Redux store. Provider wraps the app. useSelector reads state. useDispatch gets dispatcher.",
      ...
      "diagram": {
        ...
        "items": [
          {
            "label": "dispatch: send action to store",
            "color": "#818cf8"
          },
          {
            "label": "reducer: compute new state",
            "color": "#818cf8"
          },
          {
            "label": "useSelector: subscribe to state slice",
            "color": "#10b981",
            "highlight": true
          }
        ]
    ...
    },
    {
      ...
      "description": "RTK Query is built-in data fetching. createApi generates hooks, handles caching, loading, errors.",
    ...
    {
      "title": "Immer — mutable syntax for immutable updates",
      "description": "RTK uses Immer. Write \"mutable\" code in reducers. Immer produces a new immutable state.",
      ...
      "diagram": {
        ...
        "items": [
          {
            "label": "draft state: you mutate it",
            "color": "#818cf8"
          },
          {
            "label": "Immer: produces new immutable state",
            "color": "#10b981",
            "highlight": true
          },
          {
            "label": "nested updates: much cleaner",
            "color": "#10b981"
          }
        ]
      }
    },
    {
      ...
      "description": "Redux: more boilerplate, DevTools excellent, scales to large teams. Zustand: minimal API, great for most apps.",
      ...
      "diagram": {
        ...
        "items": [
          {
            "label": "Zustand: tiny API, 3 concepts",
            "color": "#10b981",
            "highlight": true
          },
          {
            "label": "Redux: conventions, DevTools, middleware",
            "color": "#818cf8"
          },
          {
            "label": "both: select state slices, no over-render",
            "color": "#818cf8"
          }
        ]
      }
