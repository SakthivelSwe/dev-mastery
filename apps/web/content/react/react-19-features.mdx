...
{
  "language": "javascript",
  "fileName": "react19.jsx",
  "steps": [
    {
      "title": "React 19 overview",
      "description": "React 19: Server Components stable, Server Actions, use() hook, ref as prop, improved hydration errors.",
      ...
      "diagram": {
        ...
        "items": [
          {
            "label": "use(): read Promise in render",
            "color": "#10b981",
            "highlight": true
          },
          {
            "label": "ref as prop: no forwardRef",
            "color": "#10b981"
          },
          {
            "label": "Server Actions stable",
            "color": "#818cf8"
          }
        ]
      }
    ...
    {
      "title": "use() hook",
      "description": "use(Promise) suspends until resolved. use(Context) replaces useContext. Can be called conditionally.",
      ...
      "diagram": {
        ...
        "steps": [
          {
            "label": "use(context): reads current value",
            "done": true
          },
          {
            "label": "use(promise): throws until resolved",
            "done": true
          },
          {
            "label": "Suspense catches throw, shows fallback",
            "active": true
          }
        ]
      }
    ...
    {
      "title": "ref as prop",
      "description": "No more forwardRef. Pass ref as a regular prop in React 19+.",
      ...
      "diagram": {
        ...
        "items": [
          {
            "label": "React 18: forwardRef() wrapper needed",
            "color": "#f59e0b"
          },
          {
            "label": "React 19: ref as regular prop",
            "color": "#10b981",
            "highlight": true
          },
          {
            "label": "backward compat: forwardRef still works",
            "color": "#818cf8"
          }
        ]
      }
    },
    {
      ...
      "description": "Form state management with server actions. Tracks pending state and action result.",
      "code": "\"use client\";\nimport { useActionState } from \"react\";\nimport { submitForm } from \"./actions\";\n\nfunction Form() {\n    const [state, action, isPending] = useActionState(submitForm, null);\n    return (\n        <form action={action}>\n            {state?.error && <p className=\"error\">{state.error}</p>}\n            {state?.success && <p>Saved!</p>}\n            <input name=\"title\" />\n            <button disabled={isPending}>\n                {isPending ? \"Saving...\" : \"Save\"}\n            </button>\n        </form>\n    );\n}",
      "diagram": {
        "kind": "flow",
        "steps": [
          {
            "label": "form submit → action fires",
            "done": true
          },
          {
            "label": "isPending: true during action",
            "done": true
          },
          {
            "label": "state: set to action return value",
            "active": true
          }
        ]
      }
    ...
    {
      "title": "useOptimistic",
      "description": "Show optimistic UI update immediately, then sync with server. Reverts if server fails.",
      ...
      "diagram": {
        ...
        "items": [
          {
            "label": "addOptimistic: immediate UI update",
            "color": "#10b981",
            "highlight": true
          },
          {
            "label": "server confirms: keep",
            "color": "#10b981"
          },
          {
            "label": "server fails: auto-revert to original",
            "color": "#818cf8"
          }
        ]
      }
