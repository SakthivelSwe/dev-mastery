...
{
  "language": "java",
  "fileName": "WhenNotMs.java",
  "steps": [
    {
      "title": "Microservices are NOT a silver bullet",
      "description": "The industry over-adopted microservices. Many teams now run \"distributed monoliths\" — all the complexity of microservices with none of the benefits.",
      ...
      "diagram": {
        "kind": "boxes",
        "title": "Distributed monolith traps",
        "items": [
          {
            "label": "synchronous call chains → cascading failures",
            "color": "#ef4444"
          },
          {
            "label": "shared database → coupling defeats the purpose",
            "color": "#ef4444",
            "highlight": true
          },
          {
            "label": "one team, 20 services → no independence",
            "color": "#ef4444"
          }
        ]
      }
    ...
    {
      "title": "When monolith is better",
      "description": "Solo developer, startup MVP, new product with unclear domain boundaries, small team (< 5 engineers). Monolith is simpler and faster to ship.",
      ...
      "diagram": {
        "kind": "boxes",
        "title": "Monolith is better when",
        "items": [
          {
            "label": "small team: < 5 engineers",
            "color": "#10b981",
            "highlight": true
          },
          {
            "label": "MVP: domain boundaries unclear",
            "color": "#10b981"
          },
          {
            "label": "no confirmed scaling need",
            "color": "#10b981"
          }
        ]
      }
    ...
    {
      "title": "Modular monolith — best of both",
      "description": "A modular monolith has clear internal modules (boundaries, no cross-module direct DB access) but deploys as one unit. Easy to extract to microservices later.",
      ...
      "diagram": {
        ...
        "items": [
          {
            "label": "ordering module: own package, hidden impl",
            "color": "#10b981"
          },
          {
            "label": "billing module: clean interface",
            "color": "#10b981",
            "highlight": true
          },
          {
            "label": "deploy: one JAR (simple)",
            "color": "#818cf8"
          },
          {
            "label": "extract module to service later when needed",
            "color": "#10b981"
          }
        ]
      }
    ...
    {
      "title": "Operational maturity required",
      "description": "Microservices require: CI/CD pipelines, container orchestration (k8s), distributed tracing, centralized logging, service discovery. Small teams often lack this.",
      ...
      "diagram": {
        "kind": "boxes",
        "title": "Required operational maturity",
        "items": [
          {
            "label": "CI/CD: automated per-service deploy",
            "color": "#818cf8"
          },
          {
            "label": "k8s: container scheduling",
            "color": "#818cf8"
          },
          {
            "label": "observability: traces, logs, metrics",
            "color": "#ef4444",
            "highlight": true
          },
          {
            "label": "without all three: don't use microservices",
            "color": "#ef4444"
          }
        ]
      }
    ...
    {
      "title": "Extract when pain is confirmed",
      "description": "Start with a monolith. Extract a service only when you have a confirmed bottleneck: team deployment conflict, scaling mismatch, or distinct technology need.",
      ...
      "diagram": {
        ...
        "steps": [
          {
            "label": "start: modular monolith",
            "done": true
          },
          {
            "label": "pain confirmed: team/scaling conflict",
            "done": true
          },
          {
            "label": "extract ONE service, validate",
            "active": true
          },
          {
