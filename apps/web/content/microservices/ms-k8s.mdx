  ...
  "steps": [
    {
      ...
      "description": "A Pod wraps one or more containers. Containers in a pod share network namespace and storage. Usually one app container per pod.",
      ...
      "diagram": {
        ...
        "items": [
          ...
          {
            "label": "env from Secrets/ConfigMaps",
            "color": "#f59e0b"
          }
        ]
      }
    ...
    {
      "title": "Deployment — rolling updates",
      "description": "A Deployment manages replica sets, rolling updates, and rollbacks. Define desired state; k8s makes it real.",
      ...
      "diagram": {
        ...
        "steps": [
          {
            "label": "deploy v2: start 1 new pod",
            "done": true
          },
          {
            "label": "wait for new pod Ready",
            "done": true
          },
          {
            "label": "terminate 1 old pod",
            "active": true
          },
          {
    ...
    },
    {
      ...
      "description": "A Service provides a stable IP/DNS in front of a set of pods (selected by label). Types: ClusterIP, NodePort, LoadBalancer.",
      "code": "apiVersion: v1\nkind: Service\nmetadata:\n  name: order-service\nspec:\n  selector:\n    app: order-service\n  ports:\n  - port: 80\n    targetPort: 8080\n  type: ClusterIP",
      "highlight": [
        6,
        7,
      ...
      "diagram": {
        ...
        "items": [
          ...
          {
            "label": "NodePort: accessible on node IP",
            "color": "#818cf8"
          },
          {
            "label": "LoadBalancer: cloud LB",
            "color": "#10b981",
            "highlight": true
          },
          {
            "label": "Ingress: HTTP routing rules",
            "color": "#818cf8"
          }
        ]
      }
    },
    {
      ...
      "description": "ConfigMap: non-sensitive config. Secret: sensitive data (passwords, tokens) stored base64-encoded. Both mount as env vars or files.",
      ...
      "diagram": {
        ...
        "items": [
          {
            "label": "ConfigMap: non-sensitive config",
            "color": "#818cf8"
          },
          {
            "label": "Secret: sensitive, base64, RBAC-protected",
            "color": "#ef4444",
            "highlight": true
          },
          {
            "label": "mount as env var or file",
            "color": "#818cf8"
          }
        ]
      }
    },
    {
      ...
      "description": "HPA scales pods based on CPU/memory or custom metrics. Requires metrics-server.",
      ...
      "diagram": {
        ...
        "steps": [
          {
            "label": "metrics-server: CPU avg > 70%",
            "done": true
          },
          {
            "label": "HPA: increase replicas",
            "done": true
          },
          {
            "label": "new pods scheduled → CPU drops",
            "active": true
          },
          {
