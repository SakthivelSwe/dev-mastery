...
{
  "language": "java",
  "fileName": "MonolithVsMs.java",
  "steps": [
    {
      "title": "Monolith — all-in-one",
      "description": "A monolith packages the entire application into one deployable unit. Simple to develop, test, and deploy initially. Becomes a bottleneck at scale.",
      ...
      "diagram": {
        ...
        "items": [
          ...
          {
            "label": "Deploy: one command",
            "color": "#10b981",
            "highlight": true
          },
          {
            "label": "Scale: replicate entire app",
            "color": "#f59e0b"
          }
        ]
      }
    ...
    {
      "title": "Monolith pain points at scale",
      "description": "Deployment coupling: every change deploys everything. Scaling: can't scale one component. Team collision: merges and build conflicts.",
      ...
      "diagram": {
        ...
        "steps": [
          {
            "label": "1 team → monolith works well",
            "done": true
          },
          {
            "label": "5+ teams → deployment friction",
            "done": true
          },
          {
            "label": "hotspot needs scaling → must scale all",
            "active": true
          },
          {
    ...
    {
      "title": "Microservices — decomposed",
      "description": "Each business capability becomes an independent service. Own codebase, own DB, own deployment pipeline. Teams can ship independently.",
      ...
      "diagram": {
        ...
        "items": [
          {
            "label": "order-service (own deploy)",
            "color": "#10b981"
          },
          {
            "label": "user-service (own DB)",
            "color": "#10b981"
          },
          {
            "label": "payment-service (scales independently)",
            "color": "#10b981",
            "highlight": true
          },
          {
            "label": "each team owns one service",
            "color": "#818cf8"
          }
        ]
      }
    },
    {
      ...
      "description": "Migrate a monolith to microservices incrementally. Route traffic for one capability to a new service; keep the rest in the monolith.",
      ...
      "diagram": {
        ...
        "steps": [
          {
            "label": "monolith handles everything",
            "done": true
          },
          {
            "label": "extract payment-service → route /payments there",
            "done": true
          },
          {
            "label": "extract user-service → route /users there",
            "active": true
          },
          {
    ...
    },
    {
      ...
      "description": "Don't start with microservices. Build a modular monolith first. Decompose when teams/deployments become bottlenecks.",
      ...
      "diagram": {
        ...
        "items": [
          {
            "label": "< 5 developers: monolith",
            "color": "#10b981"
          },
          {
            "label": "10+ developers: consider modules",
            "color": "#818cf8"
          },
          {
            "label": "multiple teams: microservices viable",
            "color": "#10b981",
            "highlight": true
          }
        ]
