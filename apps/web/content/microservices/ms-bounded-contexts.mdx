...
{
  "language": "java",
  "fileName": "BoundedContext.java",
  "steps": [
    {
      "title": "What is a bounded context?",
      "description": "A bounded context is a logical boundary within which a particular domain model is consistent. \"Order\" means different things to billing vs. fulfillment — they are different models.",
      ...
      "diagram": {
        ...
        "items": [
          {
            "label": "billing context: Order has price/payment",
            "color": "#818cf8"
          },
          {
            "label": "fulfillment context: Order has items/shipment",
            "color": "#10b981",
            "highlight": true
          },
          {
            "label": "same word, different models — that is OK",
            "color": "#818cf8"
          }
        ]
      }
    ...
    {
      "title": "Context map — relationships",
      "description": "How bounded contexts relate: partnership (teams collaborate), customer/supplier (upstream/downstream), conformist (downstream adopts upstream model).",
      ...
      "diagram": {
        ...
        "messages": [
          {
            "from": "billing",
            "to": "translation layer",
            "label": "InvoiceCreated event (billing model)"
          },
          {
            "from": "translation layer",
            "to": "fulfillment",
            "label": "ShipmentApproved (fulfillment model)"
          }
        ]
      }
    },
    {
      ...
      "description": "When integrating with a legacy or external system, an Anti-Corruption Layer (ACL) translates between their model and yours.",
      ...
      "diagram": {
        ...
        "steps": [
          {
            "label": "external: ChargeResponse model",
            "done": true
          },
          {
            "label": "ACL: translate to our domain model",
            "done": true
          },
          {
            "label": "our service: works with Payment model",
            "active": true
          },
          {
    ...
    {
      "title": "Ubiquitous language per context",
      "description": "Within each bounded context, all code, tests, and documentation use the same language as the domain experts. \"Order\" in billing = always billing's definition.",
      ...
      "diagram": {
        ...
        "items": [
          {
            "label": "billing: invoice, charge, payment",
            "color": "#818cf8"
          },
          {
            "label": "fulfillment: shipment, pick, pack, dispatch",
            "color": "#10b981",
            "highlight": true
          },
          {
            "label": "each context has its own vocabulary",
            "color": "#818cf8"
          }
        ]
      }
    ...
    {
      "title": "Bounded context = microservice boundary",
      "description": "Bounded contexts often map 1:1 to microservices. They define natural deployment boundaries with minimal cross-context coupling.",
      ...
      "diagram": {
        "kind": "boxes",
        "title": "BC to microservice",
        "items": [
          {
            "label": "billing BC → billing-service",
            "color": "#10b981"
          },
          {
            "label": "fulfillment BC → fulfillment-service",
            "color": "#10b981"
          },
          {
            "label": "inventory BC → inventory-service",
            "color": "#10b981",
            "highlight": true
          },
          {
            "label": "natural alignment of team + code + deploy",
            "color": "#818cf8"
          }
        ]
      }
