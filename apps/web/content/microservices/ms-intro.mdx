...
{
  "language": "java",
  "fileName": "MsIntro.java",
  "steps": [
    {
      "title": "What are microservices?",
      "description": "Microservices is an architectural style that structures an application as a collection of small, independently deployable services, each running in its own process and communicating via APIs.",
    ...
    },
    {
      ...
      "description": "Database-per-service: each microservice has its own database, schema, or table space. No direct DB access across services.",
    ...
    },
    {
      ...
      "description": "Each microservice can be deployed independently. A change to payment-service doesn't require redeploying user-service or order-service.",
      ...
      "diagram": {
        ...
        "steps": [
          {
            "label": "v2 of payment-service ready",
            "done": true
          },
          {
            "label": "rolling deploy: payment-service pods updated",
            "done": true
          },
          {
            "label": "user-service + order-service: UNCHANGED",
            "active": true
          },
          {
    ...
    {
      "title": "Communication: sync vs async",
      "description": "Sync: REST/gRPC — caller waits for response. Async: message broker (Kafka/RabbitMQ) — fire and forget, better resilience.",
      ...
      "diagram": {
        ...
        "items": [
          {
            "label": "REST/gRPC (sync)",
            "color": "#f59e0b",
            "value": "real-time, tight coupling"
          },
          {
            "label": "Kafka/AMQP (async)",
            "color": "#10b981",
            "value": "decoupled, resilient",
            "highlight": true
          }
        ]
      }
    },
    {
      ...
      "description": "Benefits: independent scaling, technology diversity, small teams. Costs: distributed systems complexity, network latency, eventual consistency.",
      ...
      "diagram": {
        ...
        "items": [
          ...
          {
            "label": "smaller codebases",
            "color": "#10b981"
          },
          {
            "label": "distributed complexity",
            "color": "#ef4444"
          },
          {
