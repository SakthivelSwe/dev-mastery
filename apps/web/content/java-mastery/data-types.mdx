  ...
  "steps": [
    ...
    },
    {
      ...
      "diagram": {
        ...
        "steps": [
          {
            "label": "byte op byte → int (promoted)",
            "done": true
          },
          {
            "label": "int op long → long",
            "done": true
          },
          {
            "label": "int op double → double",
            "active": true
          },
          {
      ...
      "diagram": {
        ...
        "items": [
          ...
          },
          {
            "label": "== for objects",
            "color": "#ef4444",
            "value": "reference compare"
          },
          {
            "label": ".equals()",
            "color": "#10b981",
            "value": "content compare",
            "highlight": true
          }
        ]
      }
