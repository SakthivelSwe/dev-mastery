  ...
  "steps": [
    {
      ...
      "description": "Breadth-First Search explores layer by layer — all neighbours before going deeper. Uses a FIFO Queue. Finds shortest path (unweighted).",
        ...
        "messages": [
          {
            "from": "Queue",
            "to": "Graph",
            "label": "poll start → visit neighbors"
          },
          {
            "from": "Queue",
            "to": "Graph",
            "label": "poll layer-1 → visit layer-2"
          }
        ]
      }
    },
    {
      ...
      "description": "Add all neighbours of the current level to the queue before processing them. This guarantees you visit all level-k nodes before level-k+1.",
    ...
    },
    {
      ...
      "description": "When edges are unweighted, BFS guarantees the first time a node is visited is via the shortest path.",
      ...
      "diagram": {
        ...
        "steps": [
          {
            "label": "BFS explores layer by layer",
            "done": true
          },
          {
            "label": "record parent of each visited node",
            "done": true
          },
          {
            "label": "trace back from end to start via parent map",
            "active": true
          }
        ]
      }
    },
    {
      ...
      "description": "O(V + E) time: every vertex and edge is visited at most once. O(V) space for the queue and visited set.",
    ...
    {
      "title": "BFS vs DFS",
      "description": "BFS: shortest path, level-order, queue. DFS: explore deeply, backtrack, stack/recursion.",
      ...
      "diagram": {
        ...
        "items": [
          {
            "label": "BFS",
            "value": "queue · shortest path · layer-by-layer",
            "color": "#10b981",
            "highlight": true
          },
          {
            "label": "DFS",
            "value": "stack · deep dive · backtrack",
            "color": "#818cf8"
          }
        ]
      }
