  ...
  "steps": [
    {
      ...
      "description": "Without rate limiting, a single misbehaving client, bot, or DDOS attack can exhaust your resources and degrade service for all users.",
      ...
      "diagram": {
        ...
        "steps": [
          ...
          {
            "label": "check: has this user exceeded their quota?",
            "active": true
          },
          {
    ...
    },
    {
      ...
      "description": "A bucket holds N tokens. Each request consumes 1 token. Tokens replenish at R/sec. Allows burst up to N, sustained rate R.",
    ...
    {
      "title": "Sliding window counter in Redis",
      "description": "For distributed rate limiting: store a sorted set in Redis with timestamps. Count requests in the last window.",
    ...
    },
    {
      ...
      "description": "Requests queue up; the bucket leaks at a constant rate. Caps burst. Unlike token bucket, output is always smooth.",
      ...
      "diagram": {
        ...
        "items": [
          ...
          {
            "label": "output: constant R",
            "color": "#10b981"
          },
          {
            "label": "queue full → drop",
            "color": "#ef4444"
          }
        ]
      }
    ...
    {
      "title": "Spring + Resilience4j rate limiter",
      "description": "Production-ready rate limiter with Resilience4j: request-level limits with fallback behaviour.",
      ...
      "diagram": {
        ...
        "steps": [
          {
            "label": "@RateLimiter checks permit",
            "done": true
          },
          {
            "label": "permit available → call search()",
            "done": true
          },
          {
            "label": "RequestNotPermitted → fallbackSearch()",
            "active": true
          }
        ]
      }
