  ...
  "steps": [
    {
      ...
      "description": "A class should have only ONE reason to change. If a class handles both business logic and persistence, changes to either reason affect the whole class.",
    ...
    {
      "title": "O — Open/Closed",
      "description": "Open for extension, closed for modification. Add new behaviour by adding new code (subclass, strategy), not by editing existing code.",
    ...
    },
    {
      ...
      "description": "A subclass should be usable anywhere its parent is used without changing the correctness of the program.",
      ...
      "diagram": {
        "kind": "boxes",
        "title": "LSP: subtype must honour parent contracts",
        "items": [
          {
            "label": "Square violates area contract",
            "color": "#ef4444",
            "highlight": true
          },
          {
            "label": "Better: separate Rectangle and Square",
            "color": "#10b981"
          }
        ]
      }
    },
    {
      ...
      "description": "Don't force clients to depend on methods they don't use. Split fat interfaces into small, focused ones.",
      ...
      "diagram": {
        ...
        "items": [
          ...
          {
            "label": "Client depends only on Printer",
            "color": "#10b981",
            "highlight": true
          }
        ]
