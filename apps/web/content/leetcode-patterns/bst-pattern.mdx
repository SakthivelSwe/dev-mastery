  ...
  "steps": [
    {
      ...
      "diagram": {
        ...
        "steps": [
          {
            "label": "Compare val with root"
          },
          {
            "label": "val < root → go left"
          },
          {
            "label": "val > root → go right"
          },
          {
            "label": "Match → return"
          },
          {
            "label": "O(log n) if balanced"
          }
        ]
      }
    },
    {
      ...
      "diagram": {
        ...
        "steps": [
          {
            "label": "Track min/max bounds"
          },
          {
            "label": "Node in range?"
          },
          {
            "label": "Recurse left: max = node"
          },
          {
            "label": "Recurse right: min = node"
          },
          {
            "label": "Any invalid → false"
          }
        ]
      }
    },
    ...
    },
    {
      ...
      "diagram": {
        ...
        "steps": [
          {
            "label": "Both < root → go left"
          },
          {
            "label": "Both > root → go right"
          },
          {
            "label": "Split → root is LCA"
          },
          {
            "label": "O(log n)"
          }
    ...
    },
    {
      ...
      "diagram": {
        ...
        "steps": [
          {
            "label": "Push all left path"
          },
          {
            "label": "next() pops"
          },
          {
            "label": "Push right's left path"
          },
          {
            "label": "Amortized O(1)"
          },
