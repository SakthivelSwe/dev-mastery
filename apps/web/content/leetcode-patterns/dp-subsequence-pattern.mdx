  ...
  "steps": [
    ...
    },
    {
      ...
      "diagram": {
        ...
        "steps": [
          ...
          {
            "label": "Binary search insertion"
          },
          {
            "label": "tails[] = smallest tail per length"
          },
          {
            "label": "Length = LIS"
          }
    ...
    },
    {
      ...
      "diagram": {
        ...
        "steps": [
          {
            "label": "dp[i][0] = 1 (empty t)"
          },
          {
            "label": "Skip s[i-1]: dp[i-1][j]"
          },
          {
    ...
    },
    {
      ...
      "diagram": {
        ...
        "steps": [
          {
            "label": "* : match empty or extend"
          },
          {
            "label": "?: match one char"
          },
          {
            "label": "Exact match: consume both"
          },
          {
            "label": "dp[m][n] final"
          },
