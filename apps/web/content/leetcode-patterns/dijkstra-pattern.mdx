  ...
  "steps": [
    ...
    },
    {
      ...
      "diagram": {
        ...
        "steps": [
          ...
          {
            "label": "Dijkstra from k"
          },
          {
            "label": "dist[v] for all v"
          },
          {
            "label": "Max reachable"
          },
          {
            "label": "Or -1 if unreachable"
          }
        ]
      }
    },
    {
      ...
      "diagram": {
        ...
        "steps": [
          {
            "label": "State = (cost, node, stops)"
          },
          {
            "label": "Track best per stops"
          },
          {
            "label": "Reached dst? return"
          },
          {
            "label": "stops > k → skip"
          },
          {
            "label": "Otherwise relax"
          }
        ]
      }
    },
    {
      ...
      "diagram": {
        ...
        "steps": [
          ...
          {
            "label": "Weight = |elevation diff|"
          },
          {
            "label": "Dijkstra minimize MAX"
          },
          {
            "label": "Reached bottom-right?"
          },
          {
            "label": "Return effort"
          }
