  ...
  "steps": [
    {
      ...
      "description": "JS silently converts types in operations.",
      "code": "// String concatenation coerces to string\n1 + '2';        // '12'\n'3' + 4;        // '34'\n\n// Subtraction coerces to number\n'5' - 2;        // 3\n'ten' - 1;      // NaN\n\n// Comparison\n'2' > 1;        // true\n'apple' > 'banana'; // false (alphabetical)\n\n// Boolean context\nif ('') { }  // falsy\nif ([]) { }  // truthy!",
      "highlight": [
        2,
        3,
        6,
      ...
      "diagram": {
        ...
        "steps": [
          {
            "label": "+ with string → string"
          },
          {
            "label": "- always numeric"
          },
          {
            "label": "Comparison coerces"
          },
          {
            "label": "if() coerces boolean"
          }
        ]
      }
    },
    {
      ...
      "description": "Convert types intentionally with String, Number, Boolean, parseInt.",
    ...
    },
    {
      ...
      "diagram": {
        ...
        "steps": [
          ...
          {
            "label": "isNaN vs Number.isNaN"
          },
          {
            "label": "Array/object stringify"
          },
          {
            "label": "JSON quirks"
          }
