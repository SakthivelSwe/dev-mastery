  ...
  "steps": [
    {
      ...
      "description": "Objects inherit from other objects via [[Prototype]] chain.",
    ...
    {
      "title": "Constructor Functions and Class",
      "description": "ES6 class is syntactic sugar over prototypal inheritance.",
      "code": "// Class syntax (ES6+)\nclass Animal {\n  constructor(name) { this.name = name; }\n  eat() { console.log(`${this.name} eats`); }\n}\n\nclass Dog extends Animal {\n  constructor(name, breed) {\n    super(name);\n    this.breed = breed;\n  }\n  bark() { console.log('woof'); }\n}\n\nconst rex = new Dog('Rex', 'Lab');\nrex.eat();   // Rex eats\nrex.bark();  // woof\n\n// Under the hood: still prototype chain\nrex.__proto__ === Dog.prototype;",
      "highlight": [
        2,
        3,
        4,
      ...
      "diagram": {
        ...
        "steps": [
          ...
          {
            "label": "rex → Dog.prototype → Animal.prototype"
          }
        ]
      }
    },
    {
      ...
      "diagram": {
        ...
        "steps": [
          {
            "label": "obj.prop lookup"
          },
          {
            "label": "Check own"
          },
          {
            "label": "Walk prototype chain"
          },
          {
            "label": "Found or undefined"
          },
          {
