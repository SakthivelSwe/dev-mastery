...
```json
{
  "steps": [
    {
      "title": "HTTP Basics",
      "description": "HyperText Transfer Protocol — stateless request/response protocol for the web.",
    ...
    {
      "title": "HTTP Methods",
      "description": "GET, POST, PUT, PATCH, DELETE, OPTIONS — verbs describing intent.",
      "code": "// GET: retrieve, safe, idempotent\nGET /api/users/123 → 200 OK { user data }\n\n// POST: create, not idempotent\nPOST /api/users { name: 'Alice' } → 201 Created\n\n// PUT: replace entire resource, idempotent\nPUT /api/users/123 { name: 'Alice', email: '...' } → 200\n\n// PATCH: partial update\nPATCH /api/users/123 { email: 'new@ex.com' } → 200\n\n// DELETE: remove, idempotent\nDELETE /api/users/123 → 204 No Content\n\n// OPTIONS: CORS preflight, capabilities",
      "highlight": [
        2,
        5,
        8,
    ...
    },
    {
      ...
      "description": "1xx (info), 2xx (success), 3xx (redirect), 4xx (client error), 5xx (server error).",
      ...
      "diagram": {
        ...
        "steps": [
          ...
          {
            "label": "4xx: your fault"
          },
          {
            "label": "5xx: server fault"
          }
        ]
      }
    },
    {
      "title": "HTTP Headers",
      "description": "Metadata sent with request and response — auth, caching, content type, CORS.",
    ...
    },
    {
      ...
      "diagram": {
        ...
        "items": [
          {
            "label": "HTTP/1.1: text, one req",
            "color": "#9e9e9e"
          },
          {
            "label": "HTTP/2: binary + multiplex",
            "color": "#1e88e5"
          },
          {
            "label": "HTTP/3: QUIC over UDP",
            "color": "#43a047"
          }
        ]
      }
