  ...
  "steps": [
    {
      ...
      "diagram": {
        ...
        "steps": [
          {
            "label": "User submits long URL"
          },
          {
            "label": "Generate short code"
          },
          {
            "label": "Store mapping"
          },
          {
            "label": "Serve redirect fast"
          },
          {
    ...
    },
    {
      ...
      "diagram": {
        ...
        "steps": [
          {
            "label": "Get next ID (counter/Snowflake)"
          },
          {
            "label": "Encode Base62"
          },
    ...
    },
    {
      ...
      "diagram": {
        ...
        "steps": [
          {
            "label": "Client hits short URL"
          },
          {
            "label": "CDN or Redis cache?"
          },
          {
            "label": "Fetch from DB if miss"
          },
          {
            "label": "Redirect 301"
          },
          {
            "label": "Track click async"
          }
        ]
      }
    }
