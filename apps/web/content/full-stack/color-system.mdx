  ...
  "steps": [
    {
      ...
      "description": "Scales (50-900), semantic tokens, contrast ratios.",
      "code": "// Color scale (Tailwind-style)\nconst blue = {\n  50:  '#eff6ff',\n  100: '#dbeafe',\n  200: '#bfdbfe',\n  300: '#93c5fd',\n  400: '#60a5fa',\n  500: '#3b82f6',  // brand default\n  600: '#2563eb',\n  700: '#1d4ed8',\n  800: '#1e40af',\n  900: '#1e3a8a',\n};\n\n// Design principles:\n// - 100 tint = 5-8% saturation adjustment\n// - Ensure WCAG AA contrast (4.5:1 for text)\n// - 500 = default/brand\n// - 900 = darkest usable\n// - 50 = lightest usable\n\n// Semantic\nconst semantic = {\n  info: blue[500],\n  success: green[500],\n  warning: amber[500],\n  danger: red[500],\n};",
      "highlight": [
        2,
        3,
        4,
      ...
      "diagram": {
        ...
        "steps": [
          ...
          {
            "label": "Consistent across product"
          },
          {
            "label": "Dark mode swappable"
          }
        ]
      }
    },
    ...
    {
      "title": "Dark Mode",
      "description": "Two themes sharing semantic tokens — swap primitives.",
      "code": "/* CSS variables approach */\n:root {\n  --color-bg: white;\n  --color-text: black;\n  --color-primary: #3b82f6;\n}\n\n[data-theme=\"dark\"] {\n  --color-bg: #0f172a;\n  --color-text: #f1f5f9;\n  --color-primary: #60a5fa;\n}\n\n/* Use in components */\n.card {\n  background: var(--color-bg);\n  color: var(--color-text);\n}\n\n/* System preference */\n@media (prefers-color-scheme: dark) {\n  :root:not([data-theme]) {\n    --color-bg: #0f172a;\n  }\n}\n\n/* Toggle */\n// document.documentElement.setAttribute('data-theme', 'dark');\n// localStorage.setItem('theme', 'dark');",
      "highlight": [
        2,
        3,
        4,
