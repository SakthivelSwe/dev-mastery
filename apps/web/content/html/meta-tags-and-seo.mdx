...
{
  "language": "html",
  "fileName": "meta-seo.html",
  "steps": [
    {
      "title": "Essential meta tags",
      "description": "<meta> tags live in <head>. charset, viewport, and description are the three most important. Without viewport, mobile browsers render desktop layout and then scale down.",
      ...
      "diagram": {
        "kind": "boxes",
        "title": "Essential head tags",
        "items": [
          {
            "label": "charset=\"UTF-8\"",
            "color": "#10b981",
            "value": "Correct character rendering",
            "highlight": true
          },
          {
            "label": "viewport",
            "color": "#818cf8",
            "value": "Mobile-responsive scaling"
          },
          {
            "label": "description",
            "color": "#f59e0b",
            "value": "Search result snippet (150-160 chars)"
          },
          {
            "label": "canonical",
            "color": "#60a5fa",
    ...
    },
    {
      ...
      "description": "Open Graph (og:) tags control how your page appears when shared on Facebook, LinkedIn, Twitter. Without them, social platforms guess and often pick wrong content.",
      ...
      "diagram": {
        ...
        "steps": [
          {
            "label": "User shares URL to Twitter/LinkedIn",
            "done": true
          },
          {
            "label": "Social platform fetches URL to scrape meta",
            "done": true
          },
          {
            "label": "og:image shown as preview card",
            "active": true
          },
          {
    ...
    },
    {
      ...
      "description": "JSON-LD embeds machine-readable structured data that powers Google rich results: star ratings, FAQs, breadcrumbs, events, products.",
      ...
      "diagram": {
        "kind": "boxes",
        "title": "Rich results types",
        "items": [
          {
            "label": "Course",
            "color": "#10b981",
            "value": "Shows in Google Courses carousel",
            "highlight": true
          },
          {
            "label": "FAQPage",
            "color": "#818cf8",
            "value": "Expands Q&A in search results"
          },
          {
            "label": "BreadcrumbList",
            "color": "#f59e0b",
            "value": "Shows path in search snippet"
          },
          {
            "label": "Product + Review",
            "color": "#60a5fa",
            "value": "Star ratings in search"
          }
        ]
      }
    },
    {
      "title": "robots and noindex",
      "description": "<meta name=\"robots\"> controls crawler behaviour. noindex prevents indexing, nofollow prevents following links, noarchive prevents cached copy.",
      ...
      "diagram": {
        ...
        "steps": [
          {
            "label": "Googlebot requests robots.txt first",
            "done": true
          },
          {
            "label": "Follows Disallow rules — skips /admin/",
            "done": true
          },
          {
            "label": "Crawls allowed pages",
            "active": true
          },
          {
    ...
    },
    {
      ...
      "description": "Google ranks pages by Core Web Vitals: LCP (load speed), FID/INP (interactivity), CLS (visual stability). These are measured in real Chrome user sessions.",
        ...
        "items": [
          {
            "label": "LCP < 2.5s",
            "color": "#10b981",
            "value": "Largest Contentful Paint — load speed",
            "highlight": true
          },
          {
            "label": "INP < 200ms",
            "color": "#818cf8",
            "value": "Interaction to Next Paint — responsiveness"
          },
          {
            "label": "CLS < 0.1",
            "color": "#f59e0b",
            "value": "Cumulative Layout Shift — visual stability"
          },
          {
            "label": "TTFB < 800ms",
            "color": "#60a5fa",
            "value": "Time to First Byte — server speed"
          }
        ]
      }
    }
