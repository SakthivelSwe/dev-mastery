...
{
  "language": "javascript",
  "fileName": "html5-apis.js",
  "steps": [
    {
      "title": "Geolocation API",
      "description": "navigator.geolocation.getCurrentPosition() asks for the user's location (requires permission). Returns latitude, longitude, and accuracy.",
      ...
      "diagram": {
        ...
        "steps": [
          {
            "label": "Call getCurrentPosition()",
            "done": true
          },
          {
            "label": "Browser shows permission prompt",
            "done": true
          },
          {
            "label": "User grants → success callback with coords",
            "active": true
          },
          {
    ...
    },
    {
      ...
      "description": "localStorage persists until explicitly cleared. sessionStorage clears when the tab closes. Both store only strings — use JSON.stringify/parse for objects.",
        ...
        "items": [
          {
            "label": "localStorage",
            "color": "#10b981",
            "value": "Persists forever (~5MB)",
            "highlight": true
          },
          {
            "label": "sessionStorage",
            "color": "#818cf8",
            "value": "Clears on tab close (~5MB)"
          },
          {
            "label": "Cookies",
            "color": "#f59e0b",
            "value": "Sent with requests, set by server"
          },
          {
            "label": "IndexedDB",
            "color": "#60a5fa",
            "value": "Async, large data, transactions"
          }
        ]
      }
    },
    {
      ...
      "description": "HTML5 Drag and Drop works via draggable attribute and drag events: dragstart, dragover, drop. Transfer data with DataTransfer object.",
      ...
      "diagram": {
        ...
        "steps": [
          {
            "label": "draggable=\"true\" on element",
            "done": true
          },
          {
            "label": "dragstart: store data in DataTransfer",
            "done": true
          },
          {
            "label": "dragover: call preventDefault() to allow drop",
            "active": true
          },
          {
    ...
    },
    {
      ...
      "description": "IntersectionObserver fires when elements enter or leave the viewport. Use for lazy loading images, infinite scroll, and animation triggers — no scroll event polling needed.",
      ...
      "diagram": {
        "kind": "boxes",
        "title": "Intersection Observer uses",
        "items": [
          {
            "label": "Lazy load images",
            "color": "#10b981",
            "value": "Load only when near viewport",
            "highlight": true
          },
          {
            "label": "Infinite scroll",
            "color": "#818cf8",
            "value": "Load more when sentinel visible"
          },
          {
            "label": "Scroll animations",
            "color": "#f59e0b",
            "value": "Trigger CSS class on enter"
          },
          {
            "label": "Ad visibility tracking",
            "color": "#60a5fa",
            "value": "Report % visible to analytics"
          }
        ]
      }
    },
    {
      "title": "Web Workers",
      "description": "Web Workers run JS in a background thread — no UI blocking. Main thread and worker communicate via postMessage. Workers cannot access DOM.",
