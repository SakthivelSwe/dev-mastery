...
```json
{
  ...
  "steps": [
    {
      "title": "lang attribute & direction",
      "description": "The lang attribute on <html> declares the document language. dir=\"rtl\" sets right-to-left text direction for Arabic, Hebrew, etc.",
        ...
        "items": [
          {
            "label": "lang=\"en\"",
            "color": "#10b981",
            "value": "Primary language tag",
            "highlight": true
          },
          {
            "label": "lang=\"fr-CA\"",
            "color": "#818cf8",
            "value": "Language-Region subtag"
          },
          {
            "label": "dir=\"rtl\"",
            "color": "#f59e0b",
            "value": "Right-to-left text direction"
          },
          {
            "label": "dir=\"auto\"",
            "color": "#60a5fa",
            "value": "Browser detects from content"
          }
        ]
      }
    },
    {
      "title": "Character encoding & Unicode",
      "description": "UTF-8 covers all human languages. Always declare charset early — if the browser picks wrong encoding, characters render as garbage.",
        ...
        "items": [
          {
            "label": "UTF-8",
            "color": "#10b981",
            "value": "Supports all Unicode — always use this",
            "highlight": true
          },
          {
            "label": "HTML entities &amp; &#9733;",
            "color": "#818cf8",
            "value": "Escape special chars"
          },
          {
            "label": "charset first in <head>",
            "color": "#f59e0b",
            "value": "Before any text content"
          },
          {
            "label": "BOM",
            "color": "#ef4444",
            "value": "Byte Order Mark — not needed with UTF-8"
          }
        ]
      }
    },
    {
      ...
      "description": "hreflang tells search engines about language/regional variants of a page. Use <link rel=\"alternate\"> in <head> to declare all versions.",
      ...
      "diagram": {
        ...
        "steps": [
          {
            "label": "Google finds page via sitemap/crawl",
            "done": true
          },
          {
            "label": "Reads hreflang — builds language graph",
            "done": true
          },
          {
            "label": "Shows correct version per user locale",
            "active": true
          },
          {
    ...
    {
      "title": "Number, date & currency formatting",
      "description": "The Intl API formats numbers, dates, and currencies according to locale. Never hardcode £ or $ — use Intl.NumberFormat for correct locale-aware formatting.",
      ...
      "diagram": {
        "kind": "boxes",
        "title": "Intl API methods",
        "items": [
          {
            "label": "Intl.NumberFormat",
            "color": "#10b981",
            "value": "Currency, percent, decimal",
            "highlight": true
          },
          {
            "label": "Intl.DateTimeFormat",
            "color": "#818cf8",
            "value": "Locale-aware dates & times"
          },
          {
            "label": "Intl.RelativeTimeFormat",
            "color": "#f59e0b",
            "value": "\"3 days ago\" in any language"
          },
          {
            "label": "Intl.Collator",
            "color": "#60a5fa",
            "value": "Locale-aware string sorting"
          }
        ]
      }
    },
    {
      "title": "CSS logical properties for RTL",
      "description": "CSS logical properties (margin-inline-start, padding-block) adapt automatically to text direction. Avoid left/right for i18n-compatible layouts.",
      ...
      "diagram": {
        ...
        "items": [
          ...
          },
          {
            ...
            "color": "#60a5fa",
            "value": "Replaces left: in positioned"
          }
        ]
      }
    }
