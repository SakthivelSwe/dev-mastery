  ...
  "steps": [
    {
      ...
      "description": "manifest.json makes your web app installable. It defines the app name, icons, colours, and display mode. Link it from <head> with rel=\"manifest\".",
      ...
      "diagram": {
        ...
        "items": [
          {
            "label": "display: standalone",
            "color": "#10b981",
            "value": "Full-screen, no browser chrome",
            "highlight": true
          },
          {
            "label": "theme_color",
            "color": "#818cf8",
            "value": "Mobile OS status bar colour"
          },
          {
            "label": "icons (192 + 512)",
            "color": "#f59e0b",
            "value": "Home screen + splash screen"
          },
          {
            "label": "start_url",
            "color": "#60a5fa",
            "value": "URL opened when app launched"
          }
        ]
      }
    },
    {
      ...
      "description": "Service Workers intercept network requests — enabling offline support, push notifications, and background sync. Register from your main JS file.",
      ...
      "diagram": {
        ...
        "steps": [
          {
            "label": "Register sw.js from main JS",
            "done": true
          },
          {
            "label": "SW install event: cache assets",
            "done": true
          },
          {
            "label": "SW activate: clean old caches",
            "active": true
          },
          {
    ...
    },
    {
      ...
      "description": "Service Workers can intercept fetches and apply different strategies: Cache First (fast), Network First (fresh), Stale While Revalidate (fast + eventually fresh).",
        ...
        "items": [
          {
            "label": "Cache First",
            "color": "#10b981",
            "value": "Speed: serve cache, fallback network"
          },
          {
            "label": "Network First",
            "color": "#818cf8",
            "value": "Freshness: try network, fallback cache"
          },
          {
            "label": "Stale While Revalidate",
            "color": "#f59e0b",
            "value": "Both: cache + background update",
            "highlight": true
          },
          {
            "label": "Network Only",
            "color": "#60a5fa",
            "value": "No cache — real-time data"
          }
        ]
      }
    },
    {
      ...
      "description": "Push notifications use the Push API + Notifications API. The server sends push via a push service; the Service Worker receives and shows the notification.",
      ...
      "diagram": {
        ...
        "messages": [
          ...
          },
          {
            "from": "Browser",
            "to": "Your Server",
            "label": "send subscription endpoint"
          },
          {
            "from": "Your Server",
            "to": "Push Service",
    ...
    },
    {
      ...
      "description": "Browsers fire the beforeinstallprompt event when the PWA is installable. Capture it to show your own install button at the right moment.",
      ...
      "diagram": {
        ...
        "steps": [
          {
            "label": "Browser checks: HTTPS + manifest + SW",
            "done": true
          },
          {
            "label": "beforeinstallprompt fires — save it",
            "done": true
          },
          {
            "label": "Show custom \"Install App\" button",
            "active": true
          },
          {
