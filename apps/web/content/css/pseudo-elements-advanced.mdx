...
```json
{
  "steps": [
    {
      "title": "::before and ::after Mastery",
      "description": "Generate complex visual effects purely via CSS using ::before/::after pseudo-elements.",
      "code": "/* Gradient underline */\n.link {\n  position: relative;\n  text-decoration: none;\n}\n.link::after {\n  content: '';\n  position: absolute;\n  bottom: 0; left: 0;\n  width: 100%; height: 2px;\n  background: linear-gradient(90deg, #1d4ed8, #7c3aed);\n  transform: scaleX(0);\n  transition: transform 0.3s ease;\n}\n.link:hover::after { transform: scaleX(1); }",
      "highlight": [
        6,
        7,
        8,
      ...
      "diagram": {
        ...
        "steps": [
          {
            "label": "::after width: 100%"
          },
          {
            "label": "scaleX(0) hidden"
          },
          {
            "label": "Hover triggers"
          },
          {
            "label": "scaleX(1) animates"
          },
          {
            "label": "Gradient appears"
          }
        ]
      }
    },
    {
      "title": "::marker",
      "description": "::marker styles list item bullets and numbers without needing custom markup.",
      "code": "/* Style list bullets */\nul li::marker {\n  color: #1d4ed8;\n  font-size: 1.2em;\n}\n\n/* Custom counter for ordered list */\nol {\n  counter-reset: my-counter;\n}\nol li {\n  counter-increment: my-counter;\n}\nol li::marker {\n  content: counter(my-counter, upper-roman) '. ';\n  color: #7c3aed;\n}",
      "highlight": [
        2,
        3,
        4,
    ...
    {
      "title": "::selection",
      "description": "::selection styles text when the user selects it with a cursor.",
      "code": "/* Brand-colored text selection */\n::selection {\n  background: #1d4ed8;\n  color: white;\n}\n\n/* Per-element selection */\n.code-block::selection {\n  background: #1e293b;\n  color: #7dd3fc;\n}\n\n/* Only background and color work in ::selection */",
      "highlight": [
        2,
        3,
        4,
      ...
      "diagram": {
        ...
        "steps": [
          {
            "label": "User selects text"
          },
          {
            "label": "::selection applies"
          },
          {
            "label": "background + color"
          },
          {
            "label": "Brand-styled selection"
          }
        ]
      }
    },
    {
      "title": "CSS Counters",
      "description": "CSS counters auto-number elements without JavaScript.",
      "code": "/* Table of contents numbering */\nbody { counter-reset: section; }\n\nh2 {\n  counter-increment: section;\n  counter-reset: subsection;\n}\nh2::before {\n  content: counter(section) '. ';\n}\n\nh3 { counter-increment: subsection; }\nh3::before {\n  content: counter(section) '.' counter(subsection) ' ';\n}",
      "highlight": [
        2,
        5,
        6,
      ...
      "diagram": {
        ...
        "steps": [
          {
            "label": "counter-reset: section"
          },
          {
            "label": "counter-increment"
          },
          {
            "label": "counter() in content"
          },
          {
            "label": "1. Section"
          },
          {
            "label": "1.1 Subsection"
          }
        ]
      }
    },
    {
      "title": "::placeholder and ::file-selector-button",
      "description": "Style form internals with modern pseudo-elements.",
