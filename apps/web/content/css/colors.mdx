...
```json
{
  "steps": [
    {
      "title": "Color Formats",
      "description": "CSS supports hex, rgb, hsl, lab, lch, oklch, and more color spaces.",
      "code": "/* Hex */\ncolor: #1d4ed8;\ncolor: #1d4ed8ff; /* with alpha */\n\n/* RGB */\ncolor: rgb(29, 78, 216);\ncolor: rgba(29, 78, 216, 0.8);\ncolor: rgb(29 78 216 / 80%); /* modern syntax */\n\n/* HSL */\ncolor: hsl(220, 76%, 48%);\ncolor: hsl(220 76% 48% / 80%);",
      "highlight": [
        2,
        6,
        7,
    ...
    {
      "title": "currentColor",
      "description": "currentColor inherits the current text color — useful for icon and border coloring.",
      "code": ".button {\n  color: #1d4ed8;\n  border: 2px solid currentColor; /* uses #1d4ed8 */\n}\n\n.icon {\n  fill: currentColor; /* SVG uses text color */\n}\n\n/* Hover changes both */\n.button:hover {\n  color: #1e40af;\n  /* border and icon auto-update */\n}",
      "highlight": [
        3,
        7,
        11,
      ...
      "diagram": {
        ...
        "steps": [
          ...
          {
            "label": "currentColor = #1d4ed8"
          },
          {
            "label": "border uses it"
          },
          {
            "label": "SVG fill uses it"
          }
        ]
      }
    },
    {
      "title": "Color Functions: oklch",
      "description": "oklch is the modern perceptually uniform color space — better for interpolation.",
      "code": "/* oklch(lightness chroma hue) */\n.primary   { color: oklch(55% 0.2 240); }\n.secondary { color: oklch(50% 0.15 280); }\n\n/* oklch guarantees perceptual consistency */\n/* L: 0-1 (black to white) */\n/* C: 0-0.4 (gray to vivid) */\n/* H: 0-360 (hue wheel) */\n\n/* Wide gamut colors (P3 display) */\n.vivid { color: oklch(65% 0.3 30); }",
      "highlight": [
        2,
        3,
        10
    ...
    {
      "title": "color-mix()",
      "description": "color-mix() mixes two colors in any color space directly in CSS.",
      "code": "/* Mix two colors */\ncolor: color-mix(in oklch, #1d4ed8 50%, white);\n/* 50% blue + 50% white = light blue */\n\n/* Tints and shades from one token */\n:root {\n  --brand: oklch(55% 0.2 240);\n  --brand-light: color-mix(in oklch, var(--brand) 30%, white);\n  --brand-dark:  color-mix(in oklch, var(--brand) 70%, black);\n}",
      "highlight": [
        2,
        8,
        9
    ...
    {
      "title": "Opacity and Alpha",
      "description": "Control transparency with rgba, hsla, hex alpha, or the opacity property.",
      "code": "/* Alpha channel in color */\ncolor: rgb(29, 78, 216, 0.5);   /* 50% transparent text */\nbackground: hsl(220 76% 48% / 30%); /* 30% bg */\n\n/* opacity: affects element AND children */\n.faded { opacity: 0.5; }\n\n/* Difference: */\n/* background: rgba(0,0,0,0.5) — background only */\n/* opacity: 0.5 — everything including text */",
      "highlight": [
        2,
        3,
        6,
      ...
      "diagram": {
        ...
        "items": [
          {
            "label": "rgba() — color alpha",
            "color": "#42a5f5"
          },
          {
            "label": "opacity — whole element",
            "color": "#1565c0"
          }
        ]
      }
