  ...
  "steps": [
    {
      ...
      "description": "display:grid creates a two-dimensional layout engine with rows and columns.",
    ...
    {
      "title": "fr Unit and repeat()",
      "description": "fr (fractional unit) distributes remaining space proportionally.",
      "code": "/* 3 equal columns */\ngrid-template-columns: repeat(3, 1fr);\n\n/* Auto-responsive columns */\ngrid-template-columns: repeat(auto-fill, minmax(250px, 1fr));\n/* Cards fill row, wrap when < 250px */\n\n/* Mixed: fixed + fluid */\ngrid-template-columns: 280px 1fr;",
      "highlight": [
        2,
        5,
        9
    ...
    },
    {
      ...
      "description": "Place items precisely using grid-column and grid-row span syntax.",
      "code": "/* Span across columns */\n.hero    { grid-column: 1 / -1; } /* all columns */\n.feature { grid-column: span 2; } /* 2 columns wide */\n\n/* Explicit placement */\n.sidebar {\n  grid-column: 1;\n  grid-row: 1 / 3; /* span 2 rows */\n}\n\n/* Named areas */\n.header { grid-area: header; }",
      "highlight": [
        2,
        3,
        7,
    ...
    },
    {
      ...
      "description": "Grid = 2D layouts; Flexbox = 1D layouts (row OR column). Use both together.",
      "code": "/* Grid for page layout (2D) */\n.page {\n  display: grid;\n  grid-template-areas: \"nav main aside\";\n}\n\n/* Flex for component layout (1D) */\n.nav {\n  display: flex;\n  align-items: center;\n  gap: 1rem;\n}",
      "highlight": [
        3,
        9,
        10
      ...
      "diagram": {
        ...
        "items": [
          {
            "label": "Grid: rows AND cols",
            "color": "#1e88e5"
          },
          {
            "label": "Flex: row OR col",
            "color": "#43a047"
          }
        ]
      }
    ...
    {
      "title": "subgrid",
      "description": "subgrid lets children align to the parent grid tracks — eliminates alignment hacks.",
      "code": "/* Parent grid */\n.cards {\n  display: grid;\n  grid-template-columns: repeat(3, 1fr);\n}\n\n/* Card inherits parent tracks */\n.card {\n  display: grid;\n  grid-template-rows: subgrid; /* aligns to parent rows */\n  grid-row: span 3;            /* occupies 3 row tracks */\n}",
      "highlight": [
        9,
        10,
        11
      ...
      "diagram": {
        ...
        "steps": [
          {
            "label": "Parent Grid Tracks"
          },
          {
            "label": "Child subgrid"
          },
          {
            "label": "Aligned to parent rows"
          },
          {
            "label": "Cards same height"
          }
        ]
      }
    }
