...
```json
{
  "steps": [
    {
      "title": "Custom Properties Basics",
      "description": "CSS custom properties (variables) store values that can be reused and changed at runtime.",
      "code": "/* Define on :root (global scope) */\n:root {\n  --color-primary: #1d4ed8;\n  --spacing-4: 1rem;\n  --radius-md: 0.5rem;\n}\n\n/* Use with var() */\n.button {\n  background: var(--color-primary);\n  padding: var(--spacing-4);\n  border-radius: var(--radius-md);\n}",
      "highlight": [
        3,
        4,
        5,
    ...
    },
    {
      ...
      "description": "Variables cascade — define on a component for local scope.",
      "code": "/* Global default */\n:root { --button-bg: #1d4ed8; }\n\n/* Override in a component scope */\n.card {\n  --button-bg: #7c3aed; /* purple inside cards */\n}\n\n/* Danger variant */\n[data-variant=\"danger\"] {\n  --button-bg: #dc2626;\n}\n\n.button { background: var(--button-bg); }",
      "highlight": [
        2,
        6,
        11,
    ...
    {
      "title": "Dynamic Variables with JS",
      "description": "Read and write CSS variables from JavaScript for dynamic theming.",
      "code": "// Read CSS variable\nconst root = document.documentElement;\nconst color = getComputedStyle(root)\n  .getPropertyValue('--color-primary').trim();\n\n// Write CSS variable\nroot.style.setProperty('--color-primary', '#7c3aed');\n\n// Theme switching\nfunction setTheme(theme) {\n  root.dataset.theme = theme;\n  // CSS [data-theme=\"dark\"] { --color-bg: #0f172a; }\n}",
      "highlight": [
        3,
        4,
        7,
    ...
    {
      "title": "CSS Variables for Animation",
      "description": "CSS variables enable elegant animation control via JavaScript.",
      "code": "/* Animation progress via variable */\n.progress-bar {\n  --progress: 0;\n  width: calc(var(--progress) * 1%);\n  transition: width 0.3s ease;\n}\n\n/* JS: update progress */\nbar.style.setProperty('--progress', '75');\n\n/* Staggered animation */\n.item { animation-delay: calc(var(--index) * 100ms); }",
      "highlight": [
        3,
        4,
        9,
