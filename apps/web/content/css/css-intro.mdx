...
```json
{
  "steps": [
    {
      "title": "What is CSS?",
      "description": "CSS (Cascading Style Sheets) controls the visual presentation of HTML. Browsers apply a cascade of rules to determine final styles.",
      "code": "/* Basic CSS rule anatomy */\nselector {\n  property: value;\n}\n\n/* Example */\nh1 {\n  color: #1e40af;\n  font-size: 2rem;\n  margin-bottom: 1rem;\n}",
      "highlight": [
        2,
        3,
        7,
    ...
    {
      "title": "The Cascade",
      "description": "Cascade determines which rule wins when multiple rules target the same element.",
      "code": "/* Order matters: last wins (same specificity) */\np { color: red; }\np { color: blue; } /* wins: blue */\n\n/* Importance overrides */\np { color: red !important; } /* wins always */\n\n/* Origin order: user agent → author → user */",
      "highlight": [
        3,
        5
      ],
    ...
    },
    {
      ...
      "description": "Specificity: inline > ID > class/attr/pseudo > element. Calculate as (a,b,c).",
      "code": "/* Specificity (id, class, element) */\np              { } /* 0,0,1 */\n.text          { } /* 0,1,0 */\n#title         { } /* 1,0,0 */\ndiv.card p     { } /* 0,1,2 */\n#nav .item:hover { } /* 1,1,1 */\n\n/* Inline style = 1,0,0,0 — highest */\n<p style=\"color:red\">",
      "highlight": [
        2,
        3,
        4,
    ...
    {
      "title": "Inheritance",
      "description": "Some CSS properties inherit from parent to child; others do not.",
      "code": "/* Inherited: color, font, line-height, etc. */\nbody { color: #333; font-family: sans-serif; }\np { /* inherits color and font from body */ }\n\n/* Not inherited: margin, padding, border, etc. */\ndiv { border: 1px solid black; }\nspan { /* no border inherited */ }\n\n/* Force inheritance */\nbutton { color: inherit; font: inherit; }",
      "highlight": [
        2,
        9
      ],
      "diagram": {
        ...
        "boxes": [
          {
            "id": "y",
            "label": "Inherited: color, font",
            "color": "#43a047"
          },
          {
            "id": "n",
            "label": "Not inherited: border, padding",
            "color": "#e53935"
          }
        ],
        "connections": []
