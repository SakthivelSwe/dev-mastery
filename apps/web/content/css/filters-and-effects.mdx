...
```json
{
  "steps": [
    {
      "title": "CSS filter",
      "description": "filter applies graphical effects like blur, brightness, contrast, and grayscale.",
    ...
    },
    {
      ...
      "description": "backdrop-filter applies effects to the area behind an element — frosted glass UI.",
      "code": "/* Frosted glass navigation */\n.navbar {\n  background: rgba(255, 255, 255, 0.7);\n  backdrop-filter: blur(12px) saturate(1.5);\n  -webkit-backdrop-filter: blur(12px) saturate(1.5);\n  border-bottom: 1px solid rgba(255,255,255,0.3);\n}\n\n/* Modal backdrop */\n.modal-overlay {\n  backdrop-filter: blur(4px) brightness(0.9);\n  background: rgba(0,0,0,0.5);\n}",
      "highlight": [
        4,
        5,
        10,
      ...
      "diagram": {
        ...
        "steps": [
          {
            "label": "Element positioned"
          },
          {
            "label": "backdrop-filter"
          },
          {
            "label": "Blurs content behind"
          },
          {
    ...
    },
    {
      ...
      "description": "mix-blend-mode controls how an element blends with what is behind it.",
      "code": "/* Multiply blend: darkens */\n.dark-text {\n  mix-blend-mode: multiply;\n  color: #1d4ed8;\n}\n\n/* Screen blend: lightens */\n.light-layer {\n  mix-blend-mode: screen;\n}\n\n/* Overlay: increase contrast */\n.overlay {\n  mix-blend-mode: overlay;\n}",
      "highlight": [
        3,
        9,
        14
      ...
      "diagram": {
        ...
        "items": [
          {
            "label": "multiply (darkens)",
            "color": "#37474f"
          },
          {
            "label": "screen (lightens)",
            "color": "#90caf9"
          },
          {
    ...
    {
      "title": "clip-path",
      "description": "clip-path clips an element to a geometric shape.",
      ...
      "diagram": {
        ...
        "steps": [
          {
            "label": "clip-path defined"
          },
          {
            "label": "Path calculated"
          },
          {
            "label": "Outside clipped away"
          },
          {
            "label": "Shape visible"
          }
    ...
    {
      "title": "CSS Masking",
      "description": "mask allows complex masking using images, gradients, or SVG paths.",
      "code": "/* Fade out bottom of image */\n.fade-bottom {\n  mask-image: linear-gradient(\n    to bottom,\n    black 60%,\n    transparent 100%\n  );\n}\n\n/* Reveal on hover */\n.reveal {\n  mask-image: linear-gradient(90deg, black var(--p), transparent var(--p));\n  transition: --p 0.5s;\n  --p: 0%;\n}\n.reveal:hover { --p: 100%; }",
      "highlight": [
        3,
        4,
        5,
      ...
      "diagram": {
        ...
        "steps": [
          {
            "label": "mask-image gradient"
          },
          {
            "label": "Black = visible"
          },
          {
            "label": "Transparent = hidden"
          },
          {
            "label": "Smooth mask edge"
          }
        ]
      }
    }
