...
```json
{
  "steps": [
    {
      "title": "calc()",
      "description": "calc() performs arithmetic with mixed units — enables powerful dynamic sizing.",
      "code": "/* Mixed units */\n.sidebar { width: calc(25% - 1rem); }\n.hero    { height: calc(100vh - 64px); } /* full viewport minus header */\n\n/* Nested calc */\n.complex {\n  padding: calc(clamp(1rem, 3vw, 2rem) / 2);\n}\n\n/* CSS variable math */\n:root { --cols: 3; }\n.grid-item {\n  width: calc(100% / var(--cols) - var(--gap));\n}",
      "highlight": [
        2,
        3,
        7,
      ...
      "diagram": {
        ...
        "steps": [
          ...
          {
            "label": "Mixed units resolved"
          },
          {
            "label": "Computed value"
          },
          {
            "label": "Applied to element"
          }
        ]
      }
    },
    {
      "title": "clamp()",
      "description": "clamp(min, preferred, max) creates fluid values that never exceed bounds.",
      "code": "/* Fluid font size: between 1rem and 3rem */\nfont-size: clamp(1rem, 2.5vw + 0.5rem, 3rem);\n\n/* Fluid padding */\npadding: clamp(1rem, 4%, 3rem);\n\n/* Fluid width */\n.card { width: clamp(280px, 45%, 500px); }\n\n/* Container width */\n.content {\n  width: clamp(320px, 90vw, 1200px);\n  margin: 0 auto;\n}",
      "highlight": [
        2,
        5,
        7,
      ...
      "diagram": {
        ...
        "steps": [
          ...
          {
            "label": "Never below min"
          },
          {
            "label": "Never above max"
          },
          {
            "label": "Fluid between"
          }
    ...
    {
      "title": "min() and max()",
      "description": "min() picks the smallest value; max() picks the largest — for one-liner responsive sizing.",
      "code": "/* min() — use smaller of two values */\n.container {\n  width: min(100%, 1200px); /* responsive max-width in one line */\n}\n\n/* max() — use larger of two values */\n.input {\n  width: max(50%, 300px); /* minimum 300px */\n}\n\n/* Combine */\n.hero {\n  height: max(50vh, min(600px, 100vh));\n}",
      "highlight": [
        3,
        8,
        12
      ...
      "diagram": {
        ...
        "steps": [
          {
            "label": "min(100%, 1200px)"
          },
          {
            "label": "100% on small screens"
          },
          {
            "label": "1200px on large screens"
          },
          {
            "label": "No media query needed"
          }
        ]
      }
    },
    {
      "title": "env() and attr()",
      "description": "env() accesses environment variables; attr() uses HTML attribute values.",
      "code": "/* env() — safe area insets (notched phones) */\n.bottom-nav {\n  padding-bottom: calc(1rem + env(safe-area-inset-bottom));\n}\n\n.header {\n  padding-top: env(safe-area-inset-top);\n}\n\n/* attr() — use HTML attribute in content */\n.tooltip[data-tooltip]::before {\n  content: attr(data-tooltip);\n}",
      "highlight": [
        3,
        7,
        11
    ...
    },
    {
      ...
      "description": "oklch(), lch(), lab(), and color() enable modern perceptually uniform colors.",
      "code": "/* oklch: perceptually uniform */\n.primary { color: oklch(55% 0.2 240); }\n\n/* color(): access P3 wide gamut */\n.vivid { color: color(display-p3 0.1 0.4 0.9); }\n\n/* relative color syntax (CSS 4) */\n.tint {\n  /* Based on --brand, lighter version */\n  color: oklch(from var(--brand) calc(l + 0.2) c h);\n}\n\n/* light-dark() function */\n.text { color: light-dark(#111, #eee); }",
      "highlight": [
        2,
        5,
        10,
