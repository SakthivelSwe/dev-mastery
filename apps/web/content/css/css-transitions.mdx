  ...
  "steps": [
    {
      ...
      "description": "Transitions smoothly animate between two states triggered by state changes.",
      "code": ".link {\n  color: #1d4ed8;\n  transition: color 0.2s ease;\n}\n.link:hover {\n  color: #7c3aed;\n}\n/* color animates over 200ms on hover */",
      "highlight": [
        3,
        5,
        6
    ...
    },
    {
      ...
      "description": "Transition has 4 sub-properties: property, duration, timing-function, delay.",
    ...
    },
    {
      ...
      "description": "Easing curves define the speed profile of an animation — linear, ease, cubic-bezier.",
    ...
    {
      "title": "Transitioning Display",
      "description": "display:none cannot be transitioned directly — use visibility+opacity trick.",
      "code": "/* ❌ Cannot animate display: none */\n.menu { display: none; }\n.menu.open { display: block; } /* instant, no transition */\n\n/* ✅ Use visibility + opacity */\n.menu {\n  visibility: hidden;\n  opacity: 0;\n  transition: opacity 0.3s, visibility 0.3s;\n}\n.menu.open {\n  visibility: visible;\n  opacity: 1;\n}",
      "highlight": [
        6,
        7,
        8,
    ...
    },
    {
      ...
      "description": "CSS classes + JS control smooth enter/exit transitions for dynamic elements.",
      "code": "/* Enter state */\n.panel-enter { opacity: 0; transform: translateX(-20px); }\n.panel-enter-active {\n  opacity: 1;\n  transform: translateX(0);\n  transition: all 0.3s ease;\n}\n\n/* Exit state */\n.panel-exit { opacity: 1; }\n.panel-exit-active {\n  opacity: 0;\n  transform: translateX(20px);\n  transition: all 0.3s ease;\n}",
      "highlight": [
        2,
        3,
        4,
      ...
      "diagram": {
        ...
        "steps": [
          {
            "label": "Add enter class"
          },
          {
            "label": "Transition animates in"
          },
          {
            "label": "Remove exit class"
          },
          {
            "label": "Transition animates out"
          }
        ]
      }
    }
