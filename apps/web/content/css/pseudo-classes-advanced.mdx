...
```json
{
  "steps": [
    {
      "title": ":not() and :is()",
      "description": ":not() excludes elements; :is() matches any in a list with high specificity.",
      "code": "/* :not() — exclude last item */\n.list > li:not(:last-child) {\n  border-bottom: 1px solid #eee;\n}\n\n/* :is() — match any */\n:is(h1, h2, h3, h4) {\n  font-family: var(--font-heading);\n  line-height: 1.2;\n}\n\n/* Combine */\n:is(article, section):not(.hero) > p {\n  margin-bottom: 1em;\n}",
      "highlight": [
        2,
        3,
        7,
      ...
      "diagram": {
        ...
        "steps": [
          ...
          {
            "label": ":is() matches any"
          },
          {
            "label": "Combined selectors"
          }
        ]
      }
    },
    {
      ...
      "description": ":nth-child(an+b) targets elements based on position — powerful for patterns.",
      "code": "/* Every 3rd item */\nli:nth-child(3n) { margin-right: 0; }\n\n/* First 3 items */\nli:nth-child(-n+3) { font-weight: bold; }\n\n/* Every other starting from 2nd */\nli:nth-child(2n) { background: #f5f5f5; }\n\n/* Last 2 items */\nli:nth-last-child(-n+2) { color: gray; }",
      "highlight": [
        2,
        5,
        8,
      ...
      "diagram": {
        ...
        "items": [
          ...
          {
            "label": "3n: every third",
            "color": "#42a5f5"
          },
          {
            "label": "-n+3: first three",
            "color": "#1565c0"
          }
        ]
      }
    ...
    {
      "title": ":focus-visible",
      "description": ":focus-visible shows focus rings only for keyboard navigation, not mouse clicks.",
      "code": "/* Remove default outline for all focus */\n:focus {\n  outline: none;\n}\n\n/* Show ring only for keyboard */\n:focus-visible {\n  outline: 2px solid #1d4ed8;\n  outline-offset: 2px;\n}\n\n/* Browser handles detection automatically */\n/* Mouse click → :focus only, not :focus-visible */\n/* Tab key → both :focus and :focus-visible */",
      "highlight": [
        7,
        8,
        9
    ...
    },
    {
      ...
      "description": ":has() selects a parent based on its children — a CSS game changer.",
      "code": "/* Card with image: remove padding */\n.card:has(> img:first-child) {\n  padding-top: 0;\n}\n\n/* Form with error */\n.form-group:has(input:invalid) {\n  --border-color: red;\n}\n\n/* Nav item with submenu */\n.nav-item:has(.submenu) > a::after {\n  content: ' ▾';\n}",
      "highlight": [
        2,
        7,
        12
    ...
    {
      "title": ":where() for Zero Specificity",
      "description": ":where() works like :is() but adds zero specificity — easy to override.",
      "code": "/* :is() has the specificity of its most specific arg */\n:is(#app, .container, div) p { color: red; } /* specificity: 1,0,1 */\n\n/* :where() always has 0 specificity */\n:where(#app, .container, div) p { color: red; } /* specificity: 0,0,1 */\n\n/* Great for base styles that are easy to override */\n:where(h1, h2, h3, h4, h5, h6) {\n  margin-block: 0.5em;\n  font-weight: 600;\n}",
      "highlight": [
        5,
        8,
        9,
      ...
      "diagram": {
        ...
        "items": [
          {
            "label": ":is() — high specificity",
            "color": "#e53935"
          },
          {
            "label": ":where() — zero specificity",
            "color": "#43a047"
          }
        ]
      }
