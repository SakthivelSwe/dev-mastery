  ...
  "steps": [
    {
      ...
      "diagram": {
        "kind": "flow",
        "steps": [
          "@property registers type",
          "Browser knows it's a number",
          "transition works",
          "--hue 220→280 animates"
        ]
      }
    },
    {
      ...
      "diagram": {
        ...
        "steps": [
          "@property --progress",
          "@keyframes fill to 100%",
          "gradient stops animate",
