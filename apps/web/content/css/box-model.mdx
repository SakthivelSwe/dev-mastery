  ...
  "steps": [
    {
      ...
      "description": "border-box is almost always preferred — width includes padding and border.",
      "code": "/* Reset to border-box everywhere */\n*, *::before, *::after {\n  box-sizing: border-box;\n}\n\n/* content-box (default) */\n.a { width: 200px; padding: 20px; } /* actual: 240px */\n\n/* border-box */\n.b { box-sizing: border-box; width: 200px; padding: 20px; } /* actual: 200px */",
      "highlight": [
        2,
        3,
        7,
      ...
      "diagram": {
        ...
        "items": [
          {
            "label": "content-box: width=content",
            "color": "#e53935"
          },
          {
            "label": "border-box: width=total",
            "color": "#43a047"
          }
        ]
      }
    },
    {
      ...
      "description": "Vertical margins collapse — the larger margin wins, they do not add up.",
      "code": "/* These margins collapse to 24px, NOT 40px */\nh2 { margin-bottom: 16px; }\np  { margin-top: 24px; }\n\n/* Collapse DOES NOT happen: */\n/* - Flex/Grid containers */\n/* - Elements with overflow != visible */\n/* - Floated elements */\n/* - Absolute/fixed elements */",
      "highlight": [
        2,
        3
      ],
      "diagram": {
        ...
        "steps": [
          {
            "label": "h2 margin-bottom: 16"
          },
          {
            "label": "p margin-top: 24"
          },
          {
            "label": "Collapse → 24px (larger wins)"
          }
        ]
      }
    },
    {
      "title": "Padding Tips",
      "description": "Use padding shorthand consistently — top/right/bottom/left (clockwise).",
      ...
      "diagram": {
        ...
        "items": [
          {
            "label": "1 value: all sides",
            "color": "#90caf9"
          },
          {
            "label": "2 values: TB + LR",
            "color": "#42a5f5"
          },
          {
            "label": "4 values: clockwise",
            "color": "#1565c0"
          }
        ]
      }
    },
    {
      ...
      "description": "Outline does not take up space, border does — use outline for focus rings.",
      "code": "/* Border: takes up space, affects layout */\n.btn { border: 2px solid blue; }\n\n/* Outline: no space, no layout impact */\n.btn:focus-visible {\n  outline: 2px solid blue;\n  outline-offset: 2px; /* gap between element and ring */\n}\n\n/* Never remove outline without a replacement! */\n.btn:focus { outline: none; } /* ❌ accessibility fail */",
      "highlight": [
        5,
        6,
        7,
      ...
      "diagram": {
        ...
        "items": [
          {
            "label": "border (in box model)",
            "color": "#e53935"
          },
          {
            "label": "outline (outside box)",
            "color": "#43a047"
          }
        ]
      }
    },
    {
      ...
      "description": "Use logical properties (margin-inline, padding-block) for RTL/LTR support.",
      "code": "/* Physical (direction-specific) */\nmargin-left: 1rem;\npadding-top: 0.5rem;\n\n/* Logical (adapts to writing direction) */\nmargin-inline-start: 1rem; /* left in LTR, right in RTL */\npadding-block-start: 0.5rem; /* top in LTR */\n\n/* Shorthand */\nmargin-inline: 1rem;   /* left+right */\npadding-block: 0.5rem; /* top+bottom */",
      "highlight": [
        5,
        6,
        9,
      ...
      "diagram": {
        ...
        "items": [
          {
            "label": "inline: horizontal axis",
            "color": "#1e88e5"
          },
          {
            "label": "block: vertical axis",
            "color": "#43a047"
          }
        ]
      }
