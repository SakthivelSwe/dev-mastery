  ...
  "steps": [
    {
      ...
      "description": "PostCSS transforms CSS using JavaScript plugins — it's the tool that powers Autoprefixer and Tailwind.",
      "code": "// postcss.config.js\nmodule.exports = {\n  plugins: [\n    require('postcss-import'),     // inline @import\n    require('tailwindcss'),        // tailwind utilities\n    require('autoprefixer'),        // vendor prefixes\n    require('cssnano'),            // minification\n  ],\n};\n\n// Input CSS → PostCSS pipeline → Output CSS",
      "highlight": [
        3,
        4,
        5,
    ...
    {
      "title": "Autoprefixer",
      "description": "Autoprefixer adds vendor prefixes automatically based on Browserslist targets.",
      "code": "/* Input */\n.flex-container {\n  display: flex;\n  user-select: none;\n}\n\n/* Output (Autoprefixer adds) */\n.flex-container {\n  display: -webkit-flex;\n  display: flex;\n  -webkit-user-select: none;\n  user-select: none;\n}\n\n/* Configure targets in .browserslistrc */\n> 1%, last 2 versions, not dead",
      "highlight": [
        9,
        10,
        11,
      ...
      "diagram": {
        ...
        "steps": [
          ...
          {
            "label": "Autoprefixer reads Browserslist"
          },
          {
            "label": "Add -webkit- prefixes"
          },
          {
            "label": "Compatible CSS"
          }
        ]
      }
    },
    {
      ...
      "description": "Use future CSS features today — transforms modern syntax to compatible output.",
      "code": "// postcss.config.js\nmodule.exports = {\n  plugins: [\n    require('postcss-preset-env')({\n      stage: 2, // stable enough for production\n      features: {\n        'nesting-rules': true,      // CSS nesting\n        'custom-media-queries': true,\n        'color-function': true,     // oklch etc\n      },\n    }),\n  ],\n};",
      "highlight": [
        5,
        7,
        8,
    ...
    },
    {
      ...
      "description": "cssnano removes whitespace, comments, and optimizes values for production.",
      "code": "/* Input (2.1KB) */\n.button {\n  /* Primary button */\n  display: inline-flex;\n  align-items: center;\n  padding: 0.5rem 1rem;\n  background-color: #1d4ed8;\n}\n\n/* Output (0.8KB) */\n.button{display:inline-flex;align-items:center;padding:.5rem 1rem;background-color:#1d4ed8}",
      "highlight": [
        11
      ],
      "diagram": {
    ...
    {
      "title": "Writing a PostCSS Plugin",
      "description": "PostCSS plugins are AST transformers — walk nodes and modify declarations.",
      "code": "const postcss = require('postcss');\n\nmodule.exports = postcss.plugin('postcss-rem-to-px', (opts = {}) => {\n  const base = opts.base || 16;\n  return (root) => {\n    root.walkDecls((decl) => {\n      if (decl.value.includes('rem')) {\n        decl.value = decl.value.replace(\n          /(\\d*\\.?\\d+)rem/g,\n          (_, n) => `${parseFloat(n) * base}px`\n        );\n      }\n    });\n  };\n});",
      "highlight": [
        5,
        6,
        7,
      ...
      "diagram": {
        ...
        "steps": [
          {
            "label": "PostCSS parses CSS"
          },
          {
            "label": "walkDecls()"
          },
          {
            "label": "Find rem values"
          },
          {
            "label": "Convert to px"
          },
          {
            "label": "Output updated CSS"
          }
        ]
      }
    }
