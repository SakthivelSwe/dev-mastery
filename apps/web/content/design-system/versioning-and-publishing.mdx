...
```json
{
  "steps": [
    ...
    },
    {
      ...
      "description": "Publish scoped packages to npm with access=public for open-source.",
    ...
    },
    {
      ...
      "description": "Automate testing, building, and publishing with GitHub Actions.",
