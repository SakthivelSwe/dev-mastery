  ...
  "steps": [
    {
      ...
      "description": "Use semantic HTML5 landmark elements so screen reader users can jump between sections.",
      "code": "<header role=\"banner\">\n  <nav aria-label=\"Main navigation\">\n    <ul role=\"list\">\n      <li><a href=\"/\" aria-current=\"page\">Home</a></li>\n      <li><a href=\"/about\">About</a></li>\n    </ul>\n  </nav>\n</header>\n\n<aside aria-label=\"Secondary navigation\">...</aside>\n<footer role=\"contentinfo\">...</footer>",
      "highlight": [
        2,
        4,
        9,
    ...
    {
      "title": "Active State with aria-current",
      "description": "Use aria-current=\"page\" on the current nav link for screen reader context.",
      "code": "const NavLink = ({ href, children }) => {\n  const pathname = usePathname();\n  const isActive = pathname === href;\n  return (\n    <a\n      href={href}\n      aria-current={isActive ? 'page' : undefined}\n      className={clsx(styles.link, isActive && styles.active)}\n    >\n      {children}\n    </a>\n  );\n};",
      "highlight": [
        3,
        7,
        8
    ...
    {
      "title": "Dropdown Menu",
      "description": "A dropdown needs aria-haspopup, aria-expanded, and keyboard arrow key navigation.",
      "code": "<div role=\"navigation\">\n  <button\n    aria-haspopup=\"true\"\n    aria-expanded={isOpen}\n    onClick={() => setOpen(!isOpen)}\n  >\n    Products\n  </button>\n  {isOpen && (\n    <ul role=\"menu\">\n      <li role=\"menuitem\"><a href=\"/products/a\">Product A</a></li>\n    </ul>\n  )}\n</div>",
      "highlight": [
        3,
        4,
        11
    ...
    {
      "title": "Breadcrumbs",
      "description": "Breadcrumbs use nav + aria-label=\"Breadcrumb\" and aria-current on last item.",
      "code": "<nav aria-label=\"Breadcrumb\">\n  <ol>\n    <li><a href=\"/\">Home</a></li>\n    <li><a href=\"/products\">Products</a></li>\n    <li aria-current=\"page\">Widget Pro</li>\n  </ol>\n</nav>\n\n/* CSS: separator via ::after pseudo-element */\nol li:not(:last-child)::after { content: ' / '; }",
      "highlight": [
        1,
        5,
        9,
    ...
    },
    {
      ...
      "description": "Tabs use role=\"tablist\", role=\"tab\", aria-selected, and role=\"tabpanel\" with keyboard support.",
      "code": "<div role=\"tablist\" aria-label=\"Settings sections\">\n  <button role=\"tab\" aria-selected={tab==='profile'} aria-controls=\"profile-panel\" id=\"profile-tab\">Profile</button>\n  <button role=\"tab\" aria-selected={tab==='security'} aria-controls=\"security-panel\" id=\"security-tab\">Security</button>\n</div>\n<div role=\"tabpanel\" id=\"profile-panel\" aria-labelledby=\"profile-tab\" hidden={tab!=='profile'}>\n  {/* profile content */}\n</div>",
      "highlight": [
        1,
        2,
        3,
