  ...
  "steps": [
    {
      ...
      "description": "An accessible modal must: trap focus, use role=dialog, have aria-labelledby, and restore focus on close.",
    ...
    },
    {
      ...
      "description": "Trap Tab/Shift+Tab within the modal using keydown handler.",
    ...
    },
    {
      ...
      "description": "Lock body scroll when modal is open; clicking backdrop closes it.",
    ...
    },
    {
      ...
      "description": "Drawers slide in from a side — same a11y requirements as modal but different position.",
      ...
      "diagram": {
        ...
        "steps": [
          ...
          {
            "label": "translateX(0→100%)"
          }
        ]
      }
    },
    {
      "title": "Animation with Reduced Motion",
      "description": "Always respect prefers-reduced-motion for users sensitive to animations.",
      ...
      "diagram": {
        ...
        "items": [
          {
            "label": "Normal: 200ms fade",
            "color": "#1e88e5"
          },
          {
            "label": "Reduced: instant",
            "color": "#43a047"
          }
        ]
      }
