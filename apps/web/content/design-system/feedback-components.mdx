...
```json
{
  "steps": [
    {
      "title": "Alert / Banner",
      "description": "Alerts communicate important messages — use role=\"alert\" for urgent, role=\"status\" for polite.",
    ...
    },
    {
      ...
      "description": "Toasts are ephemeral — they auto-dismiss and must use ARIA live regions.",
    ...
    },
    {
      ...
      "description": "Show loading state for long operations — use aria-valuenow for progress bars.",
    ...
    {
      "title": "Empty States",
      "description": "Empty states guide users when there is no data — include an illustration, message, and CTA.",
    ...
    },
    {
      ...
      "description": "Skeletons reduce perceived load time by showing content shape before data arrives.",
