...
```json
{
  "steps": [
    {
      "title": "Prop API Principles",
      "description": "Good component APIs are minimal, consistent, and predictable — follow the principle of least surprise.",
      "code": "// ❌ Too many arbitrary props\n<Button isLoading={true} showSpinner spinnerColor=\"blue\" />\n\n// ✅ Minimal, composable\n<Button loading>Save</Button>\n\n// ❌ Inconsistent naming\n<Input isDisabled /> <Button disabled />\n\n// ✅ Consistent naming across all components\n<Input disabled /> <Button disabled />",
      "highlight": [
        5,
        12
      ],
    ...
    },
    {
      ...
      "diagram": {
        ...
        "steps": [
          {
            "label": "Check controlled?"
          },
          {
            "label": "Use value prop"
          },
          {
            "label": "Or internal state"
          },
          {
            "label": "Emit onChange"
          }
    ...
    },
    {
      ...
      "description": "Render props decouple state logic from UI rendering.",
    ...
    {
      "title": "Event API Consistency",
      "description": "Use onChange/onBlur/onFocus patterns that mirror native DOM events.",
      "code": "// Native-like event handler signature\ninterface InputProps {\n  onChange?: (event: React.ChangeEvent<HTMLInputElement>) => void;\n  onValueChange?: (value: string) => void; // convenience\n}\n\n// Usage\n<Input\n  onChange={(e) => console.log(e.target.value)}\n  onValueChange={(val) => console.log(val)}\n/>",
      "highlight": [
        3,
        4,
        9,
      ...
      "diagram": {
        ...
        "steps": [
          ...
          {
            "label": "onValueChange(string)"
          }
        ]
      }
    },
    {
      "title": "Prop Spreading & Rest Props",
      "description": "Forward unknown props to the underlying DOM element for extensibility.",
