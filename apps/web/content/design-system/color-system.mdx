  ...
  "steps": [
    {
      ...
      "description": "Base palette → semantic tokens → component tokens: never skip tiers.",
    ...
    },
    {
      ...
      "description": "Generate 100–900 scales programmatically using HSL lightness.",
    ...
    },
    {
      ...
      "description": "Run contrast checks in your token build pipeline to catch failures early.",
