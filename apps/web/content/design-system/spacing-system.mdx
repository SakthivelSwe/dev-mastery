  ...
  "steps": [
    {
      ...
      "description": "The 8pt grid uses multiples of 8 for sizing and spacing, creating visual harmony.",
      "code": "// 8pt grid values\nconst grid8 = {\n  1: '8px',\n  2: '16px',\n  3: '24px',\n  4: '32px',\n  5: '40px',\n  6: '48px',\n};\n// Also allow 4px for tight adjustments",
      "highlight": [
        2,
        3,
        4,
    ...
    {
      "title": "Space vs Size Tokens",
      "description": "Distinguish space (gaps, margins, padding) from size (widths, heights) tokens.",
      "code": "const tokens = {\n  // Space: used for padding, margin, gap\n  space: { 1: '4px', 2: '8px', 4: '16px', 8: '32px' },\n  \n  // Size: used for component dimensions\n  size: {\n    button: { sm: '32px', md: '40px', lg: '48px' },\n    icon:   { sm: '16px', md: '24px', lg: '32px' },\n    avatar: { sm: '24px', md: '40px', lg: '56px' },\n  },\n};",
      "highlight": [
        3,
        6,
        7,
    ...
    {
      "title": "Padding vs Margin Convention",
      "description": "Components own their padding; consumers own margins between components.",
      "code": "// ✅ Component owns its internal padding\n.card {\n  padding: var(--space-4);\n}\n\n// ✅ Consumer adds space between cards\n.card + .card {\n  margin-top: var(--space-4);\n}\n\n// Or use a layout primitive\n<Stack gap={4}><Card /><Card /></Stack>",
      "highlight": [
        2,
        3,
        7,
      ...
      "diagram": {
        ...
        "steps": [
          {
            "label": "Component Padding (internal)"
          },
          {
            "label": "Layout Primitive (external gap)"
          }
        ]
      }
    },
    {
      "title": "Squish and Stretch Tokens",
      "description": "Squish tokens reduce vertical padding; stretch increases it — for density control.",
      "code": "const paddingTokens = {\n  // Square padding\n  md: '12px 12px',\n  \n  // Squish: less vertical than horizontal\n  squishMd: '8px 12px',\n  \n  // Stretch: more vertical than horizontal\n  stretchMd: '16px 12px',\n};\n\n// Usage\n.button-compact { padding: var(--padding-squish-md); }",
      "highlight": [
        3,
        6,
        9,
      ...
      "diagram": {
        ...
        "items": [
          {
            "label": "Square 12px/12px",
            "color": "#9e9e9e"
          },
          {
            "label": "Squish 8px/12px",
            "color": "#1e88e5"
          },
          {
            "label": "Stretch 16px/12px",
            "color": "#43a047"
          }
        ]
      }
    ...
    {
      "title": "Density Modes",
      "description": "Support compact/default/comfortable density via a data attribute on the root.",
      "code": "[data-density=\"compact\"] {\n  --space-component: var(--space-1);\n  --height-control: 28px;\n}\n[data-density=\"default\"] {\n  --space-component: var(--space-2);\n  --height-control: 36px;\n}\n[data-density=\"comfortable\"] {\n  --space-component: var(--space-3);\n  --height-control: 44px;\n}",
      "highlight": [
        1,
        5,
        9
