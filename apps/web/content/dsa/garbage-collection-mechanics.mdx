...
{
  "language": "java",
  "fileName": "GCMechanics.java",
  "steps": [
    {
      "title": "GC roots and reachability",
      "description": "Objects reachable from GC roots (stack variables, static fields, JNI refs) are LIVE. All others are eligible for collection.",
    ...
    },
    {
      ...
      "description": "Most objects die young. JVM divides heap into: Young Generation (Eden + S0 + S1) and Old Generation. Short-lived objects are collected cheaply in Young GC.",
      ...
      "diagram": {
        ...
        "items": [
          {
            "label": "Eden: new allocations",
            "color": "#10b981"
          },
          {
            "label": "Survivor S0/S1: survived 1+ minor GC",
            "color": "#818cf8"
          },
          {
            "label": "Old Gen: long-lived objects",
            "color": "#818cf8",
            "highlight": true
          },
          {
            "label": "Meta: class metadata (not heap)",
            "color": "#818cf8"
          }
        ]
      }
    ...
    {
      "title": "Minor GC � copying collection",
      "description": "Minor GC uses mark-and-copy. Identify live objects in Eden, copy to Survivor space, increment age. Young GC is usually < 50ms.",
      ...
      "diagram": {
        ...
        "steps": [
          {
            "label": "mark live objects in Eden + active S0",
            "done": true
          },
          {
            "label": "copy live to S1 (increment age)",
            "done": true
          },
          {
            "label": "age >= threshold (15) ? promote to Old Gen",
            "active": true
          },
          {
    ...
    {
      "title": "G1GC � Garbage First (Java 9+ default)",
      "description": "G1 divides heap into equal-size regions. Collect regions with most garbage first (hence \"Garbage First\"). Predictable pause time target.",
      ...
      "diagram": {
        ...
        "items": [
          {
            "label": "Young GC: stop-the-world, fast",
            "color": "#818cf8"
          },
          {
            "label": "Concurrent marking: parallel with app",
            "color": "#10b981",
            "highlight": true
          },
          {
            "label": "Mixed GC: young + old regions",
            "color": "#818cf8"
          },
          {
            "label": "pause target: MaxGCPauseMillis",
            "color": "#818cf8"
          }
        ]
      }
    ...
    {
      "title": "ZGC / Shenandoah � sub-ms pauses",
      "description": "ZGC (Java 15+) and Shenandoah perform concurrent compaction. Stop-the-world pauses < 1ms regardless of heap size.",
      ...
      "diagram": {
        ...
        "items": [
          {
            "label": "G1: < 200ms pause (default)",
            "color": "#818cf8"
          },
          {
            "label": "ZGC: < 1ms pause, 15% overhead",
            "color": "#10b981",
            "highlight": true
          },
          {
            "label": "Shenandoah: < 1ms, different impl",
            "color": "#818cf8"
          },
          {
            "label": "Serial/Parallel: throughput-optimized",
            "color": "#818cf8"
          }
        ]
      }
