  ...
  "steps": [
    {
      ...
      "description": "Objects are key-value pairs. Dot notation for known keys. Bracket notation for dynamic keys. Shorthand property syntax (ES6).",
    ...
    },
    {
      ...
      "description": "Object.keys: array of keys. Object.values: array of values. Object.entries: array of [key, value] pairs. All return own enumerable properties.",
      ...
      "diagram": {
        ...
        "items": [
          {
            "label": "Object.keys → string[]",
            "color": "#818cf8"
          },
          {
            "label": "Object.values → any[]",
            "color": "#818cf8"
          },
          {
            "label": "Object.entries + for-of: best loop",
            "color": "#10b981",
            "highlight": true
          }
        ]
    ...
    },
    {
      ...
      "description": "Shallow copy: spread {...obj} or Object.assign. Deep copy: structuredClone (modern) or JSON.parse(JSON.stringify()) (hacky).",
      "code": "// Shallow copy\nconst copy = { ...original };\nconst copy2 = Object.assign({}, original);\n\n// Merge\nconst merged = { ...defaults, ...overrides };\n\n// Deep copy\nconst deep = structuredClone(original);  // modern\n// JSON.parse(JSON.stringify(x)) — loses Date, undefined, functions",
      "diagram": {
        "kind": "boxes",
        "title": "Cloning approaches",
        "items": [
          {
            "label": "{...obj}: shallow copy",
            "color": "#818cf8"
          },
          {
            "label": "{...a,...b}: merge (b wins)",
            "color": "#818cf8"
          },
          {
          ...
          {
            "label": "JSON trick: no dates/undefined/functions",
            "color": "#f59e0b"
          }
        ]
      }
    ...
    {
      "title": "Property descriptors and Object.freeze",
      "description": "Each property has hidden descriptors: writable, enumerable, configurable. Object.freeze makes all non-writable and non-configurable (shallow).",
      ...
      "diagram": {
        ...
        "items": [
          {
            "label": "writable:false — cannot change value",
            "color": "#818cf8"
          },
          {
            "label": "configurable:false — cannot delete",
            "color": "#818cf8"
          },
          {
            "label": "shallow only — nested objects mutable",
            "color": "#f59e0b",
            "highlight": true
          }
        ]
    ...
    },
    {
      ...
      "description": "?. accesses nested properties safely. ?? provides default for null/undefined only.",
      ...
      "diagram": {
        ...
        "items": [
          {
            "label": "?.: short circuit on null/undefined",
            "color": "#10b981",
            "highlight": true
          },
          {
            "label": "??:default for null/undefined ONLY",
            "color": "#10b981"
          },
          {
            "label": "||: default for all falsy (0,\"\" too)",
            "color": "#f59e0b"
          }
        ]
      }
