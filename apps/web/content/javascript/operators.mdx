  ...
  "steps": [
    {
      ...
      "description": "== does type coercion before comparison. === checks type AND value. Always use === (with rare exceptions).",
      ...
      "diagram": {
        ...
        "items": [
          ...
          {
            "label": "exception: x == null checks null||undefined",
            "color": "#818cf8"
          }
        ]
      }
    },
    {
      ...
      "description": "&& returns first falsy or last value. || returns first truthy or last value. ?? returns right if left is null/undefined only.",
      ...
      "diagram": {
        ...
        "items": [
          {
            "label": "||: falsy → right operand",
            "color": "#818cf8"
          },
          {
            "label": "&&: truthy → right; else left",
            "color": "#818cf8"
          },
          {
            "label": "??: only null/undefined → right",
            "color": "#10b981",
            "highlight": true
          }
        ]
    ...
    },
    {
      ...
      "description": "?. returns undefined instead of throwing when accessing a property on null/undefined. Simplifies deep-nested safe access.",
      ...
      "diagram": {
        ...
        "steps": [
          {
            "label": "user.profile is null",
            "done": true
          },
          {
            "label": ".name would throw TypeError",
            "done": true
          },
          {
            "label": "?.name: short-circuits to undefined",
            "active": true
          },
          {
    ...
    },
    {
      ...
      "description": "Spread expands an iterable. Rest collects remaining values. Same syntax, different context.",
      ...
      "diagram": {
        ...
        "items": [
          {
            "label": "Spread: expand iterable (RHS)",
            "color": "#10b981",
            "highlight": true
          },
          {
            "label": "Rest: collect into array (LHS)",
            "color": "#818cf8"
          },
          {
            "label": "same syntax, different position",
            "color": "#818cf8"
          }
        ]
      }
    },
    {
      ...
      "description": "Bitwise ops convert numbers to 32-bit integers. &, |, ^, ~, <<, >>. Useful for flags, packing, and performance micro-opts.",
      ...
      "diagram": {
        ...
        "items": [
          {
            "label": "flag combinations: OR set, AND check",
            "color": "#818cf8"
          },
          {
            "label": "| 0: fast Math.floor",
            "color": "#10b981",
            "highlight": true
          },
          {
            "label": "careful: 32-bit int, breaks large numbers",
            "color": "#f59e0b"
          }
        ]
      }
