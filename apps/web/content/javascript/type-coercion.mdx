  ...
  "steps": [
    {
      ...
      "description": "JS silently converts types in expressions. + with string concatenates. == does coercion. Boolean contexts convert to true/false.",
      ...
      "diagram": {
        ...
        "items": [
          {
            "label": "+ : if EITHER is string → concat",
            "color": "#f59e0b",
            "highlight": true
          },
          {
            "label": "- * / : always numeric coercion",
            "color": "#818cf8"
          },
          {
            "label": "null → 0, undefined → NaN",
            "color": "#818cf8"
          }
        ]
      }
    },
    {
      ...
      "description": "Falsy values: false, 0, -0, 0n, \"\", null, undefined, NaN. Everything else is truthy (including \"0\", [], {}, negative numbers).",
      ...
      "diagram": {
        ...
        "items": [
          {
            "label": "false, 0, -0, 0n, \"\", null, undefined, NaN",
            "color": "#ef4444"
          },
          {
            "label": "\"0\" is TRUTHY (non-empty string)",
            "color": "#f59e0b",
            "highlight": true
          },
          {
            "label": "[] {} are TRUTHY (reference types)",
            "color": "#f59e0b"
          }
        ]
      }
    },
    {
      ...
      "description": "Always prefer explicit: Number(), String(), Boolean(), parseInt(), parseFloat().",
      ...
      "diagram": {
        ...
        "items": [
          ...
          {
            "label": "Number(\"abc\"): NaN — check with isNaN()",
            "color": "#f59e0b",
            "highlight": true
          },
          {
            "label": "Boolean({}): true — objects always truthy",
            "color": "#818cf8"
          }
        ]
      }
    },
    {
      ...
      "description": "Abstract equality algorithm: 1) Same type → ===. 2) null==undefined. 3) number==string: convert string to number. 4) bool → number. 5) object vs primitive: toPrimitive.",
      "code": "null == undefined  // true\nnull == false      // false\nnull == 0          // false\n\"0\" == false       // true (both → 0)\n[] == false        // true ([]→\"\", \"\"→0, false→0)\n[] == ![]          // true (famous quirk)",
      "diagram": {
        "kind": "boxes",
        "title": "== is unpredictable",
        "items": [
          {
            "label": "== rule 2: null == undefined only",
            "color": "#818cf8"
          },
          {
            "label": "\"0\" == false: both coerce to 0",
            "color": "#ef4444",
            "highlight": true
          },
          {
            "label": "just use === always",
            "color": "#10b981"
          }
        ]
      }
    },
    {
      ...
      "description": "Objects can define custom coercion via Symbol.toPrimitive or valueOf/toString.",
      "code": "class Money {\n    constructor(amount, currency) {\n        this.amount = amount;\n        this.currency = currency;\n    }\n    [Symbol.toPrimitive](hint) {\n        if (hint === \"number\") return this.amount;\n        return `${this.amount} ${this.currency}`;\n    }\n}\nconst m = new Money(10, \"USD\");\nm + 5;     // 15 (numeric hint)\n`${m}`;     // \"10 USD\" (string hint)",
      "diagram": {
        "kind": "flow",
        "steps": [
          {
            "label": "hint \"number\": arithmetic context",
            "done": true
          },
          {
            "label": "hint \"string\": template literal / String()",
            "done": true
          },
          {
            "label": "hint \"default\": + operator",
            "active": true
          }
        ]
      }
