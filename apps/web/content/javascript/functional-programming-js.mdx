...
```json
{
  ...
  "steps": [
    {
      "title": "Core FP concepts",
      "description": "Immutability, pure functions, function composition, higher-order functions. FP makes code predictable, testable, and composable.",
      ...
      "diagram": {
        ...
        "items": [
          {
            "label": "pure functions: no side effects",
            "color": "#10b981",
            "highlight": true
          },
          {
            "label": "immutable: never mutate, always create new",
            "color": "#10b981"
          },
          {
            "label": "higher-order: functions as values",
            "color": "#818cf8"
          }
        ]
      }
    },
    {
      ...
      "description": "compose(f, g)(x) = f(g(x)). Build complex transforms from small pure functions. Pipe is left-to-right; compose is right-to-left.",
      ...
      "diagram": {
        ...
        "steps": [
          {
            "label": "processUser receives user",
            "done": true
          },
          {
            "label": "step 1: trim name",
            "done": true
          },
          {
            "label": "step 2: lowercase email",
            "active": true
          },
          {
    ...
    {
      "title": "Currying",
      "description": "Transform f(a,b,c) → f(a)(b)(c). Enables partial application — pre-configure some arguments.",
      "code": "// Manual currying\nconst add = a => b => a + b;\nadd(5)(3);      // 8\nconst add5 = add(5);\nadd5(3);        // 8\nadd5(10);       // 15\n\n// Practical: event handler factory\nconst handleChange = field => e =>\n    setState(prev => ({ ...prev, [field]: e.target.value }));",
      "diagram": {
        "kind": "boxes",
        "title": "Currying benefits",
        "items": [
          {
            "label": "partial application: pre-fill args",
            "color": "#10b981",
            "highlight": true
          },
          {
            "label": "compose with pipeline",
            "color": "#818cf8"
          },
          {
            "label": "functional React: handler factories",
            "color": "#818cf8"
          }
        ]
      }
    },
    {
      ...
      "description": "FP fundamentals. map: transform. filter: select. reduce: fold. Chain them for declarative data transformations.",
      "code": "const orders = [\n    { id:1, status:\"paid\",    amount:100 },\n    { id:2, status:\"pending\", amount: 50 },\n    { id:3, status:\"paid\",    amount: 75 },\n];\nconst paidTotal = orders\n    .filter(o => o.status === \"paid\")\n    .map(o => o.amount)\n    .reduce((sum, a) => sum + a, 0);\n// 175",
      "diagram": {
        "kind": "flow",
        "steps": [
          {
            "label": "filter: [paid orders]",
            "done": true
          },
          {
            "label": "map: [100, 75]",
    ...
    {
      "title": "Functor, Monad concepts",
      "description": "Maybe monad: handle null safely. Option type: explicit absent values. These FP patterns appear in TypeScript libraries like fp-ts.",
      ...
      "diagram": {
        ...
        "items": [
          {
            "label": ".map(): transform if present",
            "color": "#818cf8"
          },
          {
            "label": ".getOrElse(): safe extract with fallback",
            "color": "#10b981",
            "highlight": true
          },
          {
            "label": "vs optional chaining (?.) native JS",
            "color": "#818cf8"
          }
        ]
      }
