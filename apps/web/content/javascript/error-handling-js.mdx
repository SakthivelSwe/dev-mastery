...
```json
{
  ...
  "steps": [
    {
      "title": "Error types",
      "description": "Built-in error types: Error, TypeError, RangeError, ReferenceError, SyntaxError, URIError. All extend Error. Create custom with class extends Error.",
      ...
      "diagram": {
        ...
        "items": [
          {
            "label": "Error: base class",
            "color": "#818cf8"
          },
          {
            "label": "TypeError: wrong type",
            "color": "#f59e0b"
          },
          {
            "label": "Custom: extend Error, add fields",
            "color": "#10b981",
            "highlight": true
          }
        ]
    ...
    {
      "title": "throw and re-throw",
      "description": "throw can throw any value (but throw Error objects for stack traces). Catch specific types with instanceof, re-throw unexpected ones.",
      ...
      "diagram": {
        ...
        "steps": [
          ...
          {
            "label": "catch: check instanceof",
            "done": true
          },
          {
            "label": "known type: handle",
            "active": true
          },
          {
    ...
    },
    {
      ...
      "description": "Unhandled Promise rejections crash Node.js. Use try/catch in async functions or .catch() on promise chains.",
      ...
      "diagram": {
        ...
        "items": [
          {
            "label": "try/catch: per-function",
            "color": "#10b981",
            "highlight": true
          },
          {
            "label": ".catch() on promise chain",
            "color": "#818cf8"
          },
          {
            "label": "unhandledRejection: global fallback",
            "color": "#818cf8"
          }
        ]
      }
    },
    {
      ...
      "description": "React error boundaries catch render errors. Use componentDidCatch or react-error-boundary library.",
      "code": "import { ErrorBoundary } from \"react-error-boundary\";\n\nfunction Fallback({ error }) {\n    return <div>Something went wrong: {error.message}</div>;\n}\n\nfunction App() {\n    return (\n        <ErrorBoundary FallbackComponent={Fallback}>\n            <RiskyComponent />\n        </ErrorBoundary>\n    );\n}",
      "diagram": {
        "kind": "flow",
        "steps": [
          {
            "label": "RiskyComponent throws during render",
            "done": true
          },
          {
            "label": "ErrorBoundary catches it",
            "done": true
          },
          {
            "label": "Fallback component rendered instead",
            "active": true
          }
        ]
      }
    },
    {
      ...
      "description": "Send errors to Sentry, Datadog, or custom endpoint. Include context: user, URL, version, stack trace.",
      ...
      "diagram": {
        ...
        "messages": [
          ...
          },
          {
            "from": "error handler",
            "to": "Sentry / backend",
            "label": "POST error + stack + context"
          },
          {
            "from": "Sentry / backend",
            "to": "error handler",
            "label": "alert team, create issue"
          }
        ]
      }
    }
