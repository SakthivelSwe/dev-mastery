  ...
  "steps": [
    {
      ...
      "description": "this is dynamic in JavaScript. Its value depends on the CALL SITE, not the definition site. Except for arrow functions.",
      ...
      "diagram": {
        "kind": "boxes",
        "title": "4 rules for this",
        "items": [
          {
            "label": "plain call: undefined (strict) / global",
            "color": "#818cf8"
          },
          {
            "label": "obj.fn(): this = obj",
            "color": "#10b981",
            "highlight": true
          },
          {
            "label": "fn.call/apply/bind: explicit",
            "color": "#818cf8"
          },
          {
            "label": "new fn(): fresh instance",
            "color": "#818cf8"
          }
        ]
      }
    },
    {
      ...
      "description": "Arrow functions do NOT bind their own this. They inherit this from the enclosing scope. This is why they are perfect for callbacks inside classes.",
      ...
      "diagram": {
        ...
        "steps": [
          {
            "label": "regular fn: setInterval calls with this=global",
            "done": true
          },
          {
            "label": "arrow fn: this = enclosing (Timer instance)",
            "active": true
          },
          {
    ...
    },
    {
      ...
      "description": "call(thisArg, ...args): invoke with explicit this. apply(thisArg, [args]): same but args as array. bind(thisArg): returns NEW function with fixed this.",
      ...
      "diagram": {
        ...
        "items": [
          {
            "label": "call: invoke immediately, spread args",
            "color": "#818cf8"
          },
          {
            "label": "apply: invoke immediately, array args",
            "color": "#818cf8"
          },
          {
            "label": "bind: returns bound function (does not invoke)",
            "color": "#10b981",
            "highlight": true
          }
        ]
    ...
    {
      "title": "Losing this",
      "description": "Passing a method as callback loses this. Fix with .bind(), arrow wrapper, or class field arrow.",
      ...
      "diagram": {
        ...
        "items": [
          {
            "label": "obj.method: standalone reference — lost this",
            "color": "#ef4444",
            "highlight": true
          },
          {
            "label": ".bind(obj): create bound function",
            "color": "#10b981"
          },
          {
            "label": "arrow class field: this captured at construct",
            "color": "#10b981"
          }
        ]
      }
    },
    {
      ...
      "description": "DOM event handlers: this is the element (regular function) or lexical this (arrow). React function components don not use this at all.",
      ...
      "diagram": {
        "kind": "boxes",
        "title": "this in DOM handlers",
        "items": [
          {
            "label": "function handler: this = target element",
            "color": "#818cf8"
          },
          {
            "label": "arrow handler: this = enclosing scope",
            "color": "#818cf8"
          },
          {
            "label": "React functional: no this at all",
            "color": "#10b981",
            "highlight": true
          }
        ]
