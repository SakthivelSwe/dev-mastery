  ...
  "steps": [
    {
      ...
      "description": "Pattern between /slashes/ or new RegExp(). Flags: g(global), i(case-insensitive), m(multiline), s(dotAll).",
      ...
      "diagram": {
        ...
        "items": [
          {
            "label": "\\d digit, \\w word char, \\s whitespace",
            "color": "#818cf8"
          },
          {
            "label": "+: one or more, *: zero or more, ?: optional",
            "color": "#818cf8"
          },
          {
            "label": "(?<name>...): named capture group",
            "color": "#10b981",
            "highlight": true
          }
        ]
    ...
    },
    {
      ...
      "description": "match, matchAll, replace, replaceAll, split, search, test.",
      ...
      "diagram": {
        ...
        "items": [
          {
            "label": "match(/g): array of all matches",
            "color": "#818cf8"
          },
          {
            "label": "matchAll(/g): iterator with indices",
            "color": "#10b981",
            "highlight": true
          },
          {
            "label": "replace(regex, fn): transform matches",
            "color": "#818cf8"
          }
        ]
      }
    },
    {
      ...
      "description": "Zero-width assertions: (?=...) lookahead, (?!...) negative lookahead, (?<=...) lookbehind.",
      ...
      "diagram": {
        ...
        "steps": [
          {
            "label": "(?=.*\\d): must contain digit somewhere",
            "done": true
          },
          {
            "label": "(?=.*[A-Z]): must contain uppercase",
            "done": true
          },
          {
            "label": ".{8,}: at least 8 chars",
            "active": true
          },
          {
    ...
    {
      "title": "Regex performance pitfalls",
      "description": "Catastrophic backtracking: nested quantifiers on similar patterns can cause exponential time. Use possessive quantifiers or atomic groups.",
      ...
      "diagram": {
        ...
        "items": [
          {
            "label": "(a+)+: catastrophic backtracking ReDOS",
            "color": "#ef4444",
            "highlight": true
          },
          {
            "label": "avoid nested quantifiers on similar chars",
            "color": "#f59e0b"
          },
          {
            "label": "always validate user-supplied patterns",
            "color": "#10b981"
          }
        ]
      }
    },
    {
      ...
      "description": "Common real-world regex patterns: URL, email, phone, IP, slug.",
      "code": "// URL\n/(https?:\\/\\/)[^\\s]+/\n\n// Email (simplified)\n/^[\\w.-]+@[\\w.-]+\\.[a-zA-Z]{2,}$/\n\n// Phone (flexible)\n/^[+]?[(]?[0-9]{1,3}[)]?[-\\s.]?[0-9]{3,}$/\n\n// URL slug\n/^[a-z0-9]+(?:-[a-z0-9]+)*$/",
      "diagram": {
        "kind": "boxes",
        ...
        "items": [
          {
            "label": "email: /^[\\w.-]+@[\\w.-]+\\.[a-z]{2,}$/",
            "color": "#818cf8"
          },
          {
            "label": "slug: /^[a-z0-9]+(?:-[a-z0-9]+)*$/",
            "color": "#10b981",
            "highlight": true
          },
          {
            "label": "test against known examples first",
            "color": "#818cf8"
          }
        ]
      }
