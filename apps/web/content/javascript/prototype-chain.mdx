  ...
  "steps": [
    {
      ...
      "description": "Object.__proto__ points to its prototype. Property lookup walks the chain until null. This is prototype-based inheritance.",
    ...
    },
    {
      ...
      "description": "Functions have a .prototype property. Objects created with new get __proto__ = Constructor.prototype.",
      "code": "function Person(name) { this.name = name; }\nPerson.prototype.greet = function() {\n    return `I am ${this.name}`;\n};\nconst alice = new Person(\"Alice\");\nalice.greet();  // \"I am Alice\"\nalice.__proto__ === Person.prototype;  // true",
      "diagram": {
        "kind": "flow",
        "steps": [
          {
            "label": "new Person(\"Alice\"): creates fresh object",
            "done": true
          },
          {
            "label": "object.__proto__ = Person.prototype",
            "done": true
          },
          {
            "label": "alice.greet(): not on alice → walks to prototype",
            "active": true
          }
        ]
      }
    ...
    {
      "title": "Class syntax desugars to prototype",
      "description": "class is syntactic sugar. The methods are placed on Constructor.prototype — same thing as manual prototype assignment.",
      ...
      "diagram": {
        ...
        "items": [
          {
            "label": "class Dog { bark() {} }",
            "color": "#818cf8"
          },
          {
            "label": "Dog.prototype.bark = fn",
            "color": "#818cf8",
            "highlight": true
          },
          {
            "label": "methods shared via prototype (not per-instance)",
            "color": "#10b981"
          }
        ]
      }
    },
    {
      ...
      "description": "Own property shadows prototype property. Setting a property always adds to the OWN object.",
      ...
      "diagram": {
        ...
        "steps": [
          {
            "label": "dog.sound: not own → walk to prototype",
            "done": true
          },
          {
            "label": "dog.sound = \"woof\": add OWN property",
            "done": true
          },
          {
            "label": "now own property SHADOWS prototype",
            "active": true
          }
        ]
      }
    ...
    {
      "title": "hasOwnProperty and prototype safety",
      "description": "Use hasOwnProperty to check own (not inherited) properties. Object.create(null) creates an object with no prototype.",
      ...
      "diagram": {
        "kind": "boxes",
        "title": "hasOwnProperty patterns",
        "items": [
          {
            "label": "hasOwnProperty: check own only",
            "color": "#818cf8"
          },
          {
            "label": "Object.hasOwn: modern, safe version",
            "color": "#10b981",
            "highlight": true
          },
          {
            "label": "Object.create(null): no prototype, pure map",
            "color": "#818cf8"
          }
        ]
      }
