...
```json
{
  ...
  "steps": [
    {
      "title": "DOM — tree of elements",
      "description": "Document Object Model: the browser parses HTML into a tree of nodes. JavaScript can query, modify, add, and remove nodes.",
    ...
    {
      "title": "Create and modify elements",
      "description": "createElement makes a new node. append/prepend/insertAdjacentElement places it. Setting innerHTML is powerful but XSS-risky.",
      "code": "// Create element\nconst li = document.createElement(\"li\");\nli.textContent = \"New item\";   // safe (not XSS)\nli.classList.add(\"item\");\nli.dataset.id = \"42\";\n\n// Append\nul.append(li);\nparent.insertAdjacentElement(\"beforeend\", li);",
      "diagram": {
        "kind": "flow",
        "steps": [
          {
            "label": "createElement: node in memory",
            "done": true
          },
          {
            "label": "set textContent / attributes",
            "done": true
          },
          {
            "label": "append to DOM → renders",
            "active": true
          }
        ]
      }
    },
    {
      ...
      "description": "addEventListener attaches handlers. Remove with removeEventListener using the same function reference. Prevent default for links/forms.",
      ...
      "diagram": {
        ...
        "messages": [
          ...
          },
          {
            "from": "parent",
            "to": "document",
            "label": "bubble up (unless stopPropagation)"
          }
        ]
      }
    },
    {
      ...
      "description": "Attach one listener to a parent instead of hundreds to children. Use event.target to identify which child triggered the event.",
      ...
      "diagram": {
        ...
        "items": [
          {
            "label": "one listener on parent, not N on children",
            "color": "#10b981",
            "highlight": true
          },
          {
            "label": "works on dynamically added children",
            "color": "#10b981"
          },
          {
            "label": "e.target.matches(selector): identify source",
            "color": "#818cf8"
          }
        ]
      }
    ...
    {
      "title": "Performance: batch DOM updates",
      "description": "Each DOM mutation can trigger reflow/repaint. Batch reads before writes. DocumentFragment for multiple inserts.",
      ...
      "diagram": {
        ...
        "items": [
          {
            "label": "interleaved read/write: multiple reflows",
            "color": "#ef4444"
          },
          {
            "label": "batch: all reads then all writes",
            "color": "#10b981",
            "highlight": true
          },
          {
            "label": "DocumentFragment: single DOM insertion",
            "color": "#10b981"
          }
        ]
      }
