  ...
  "steps": [
    {
      ...
      "description": "Extract values by position. Skip values with commas. Default values. Rest for remaining.",
      ...
      "diagram": {
        ...
        "items": [
          {
            "label": "[a, b]: position-based extraction",
            "color": "#818cf8"
          },
          {
            "label": "[x,z]: skip with comma",
            "color": "#818cf8"
          },
          {
            "label": "[...rest]: collect remaining",
            "color": "#10b981",
            "highlight": true
          }
        ]
    ...
    },
    {
      ...
      "description": "Extract by property name. Rename with colon. Default values. Nested destructuring. Rest for remaining properties.",
      ...
      "diagram": {
        ...
        "items": [
          {
            "label": "{name}: extract by key",
            "color": "#818cf8"
          },
          {
            "label": "{name: alias}: rename",
            "color": "#818cf8"
          },
          {
            "label": "{name = \"default\"}: default value",
            "color": "#10b981",
            "highlight": true
          }
        ]
    ...
    {
      "title": "Destructuring in function params",
      "description": "Destructure directly in the parameter list. Cleaner than accessing properties inside.",
      "code": "// Without\nfunction draw(config) {\n    const { x, y, color = \"black\" } = config;\n}\n\n// Inline (cleaner)\nfunction draw({ x, y, color = \"black\", radius = 5 }) {\n    ctx.arc(x, y, radius);\n    ctx.fillStyle = color;\n}",
      "diagram": {
        "kind": "flow",
        "steps": [
          {
            "label": "pass config object",
            "done": true
          },
          {
            "label": "inline destructure in signature",
            "done": true
          },
          {
            "label": "defaults applied when property missing",
            "active": true
          }
        ]
      }
    ...
    {
      "title": "Nested and complex destructuring",
      "description": "Destructure deeply nested structures. Combine array + object. Use with API responses.",
      ...
      "diagram": {
        ...
        "items": [
          {
            "label": "{ data: { users: [first, ...rest] } }",
            "color": "#818cf8"
          },
          {
            "label": "combine object + array destructuring",
            "color": "#10b981",
            "highlight": true
          },
          {
            "label": "good for API response parsing",
            "color": "#818cf8"
          }
        ]
      }
    },
    {
      ...
      "description": "React props, function parameters, import specific exports, swap variables, ignore unwanted returns.",
      "code": "// React component\nfunction Card({ title, description, imageUrl }) {}\n\n// Swap\n[a, b] = [b, a];\n\n// Import specific exports\nimport { useState, useEffect } from \"react\";\n\n// Ignore some returns\nconst [, second] = [1, 2, 3];",
      "diagram": {
        "kind": "boxes",
        "title": "Destructuring use cases",
        "items": [
          {
            "label": "React props: function Card({title, body})",
            "color": "#10b981",
            "highlight": true
          },
          {
            "label": "[a,b]=[b,a]: variable swap",
            "color": "#818cf8"
          },
          {
            "label": "{useState}: named imports",
            "color": "#818cf8"
          }
        ]
      }
