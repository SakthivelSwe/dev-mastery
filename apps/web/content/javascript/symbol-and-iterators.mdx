...
```json
{
  ...
  "steps": [
    {
      "title": "Symbol — unique primitive",
      "description": "Symbol() creates a globally unique identifier. Never equal to any other value. Perfect for non-colliding property keys.",
      ...
      "diagram": {
        ...
        "items": [
          {
            "label": "Symbol(): new unique key",
            "color": "#10b981",
            "highlight": true
          },
          {
            "label": "not enumerable (hidden from Object.keys)",
            "color": "#818cf8"
          },
          {
            "label": "Symbol.for(\"key\"): global registry",
            "color": "#818cf8"
          }
        ]
      }
    },
    {
      ...
      "description": "Built-in symbols customize JS behavior: Symbol.iterator, Symbol.toPrimitive, Symbol.hasInstance, Symbol.species.",
      ...
      "diagram": {
        ...
        "items": [
          {
            "label": "[Symbol.iterator](): makes class iterable",
            "color": "#10b981",
            "highlight": true
          },
          {
            "label": "works with for...of, spread, destructuring",
            "color": "#818cf8"
          },
          {
            "label": "next(): {value, done} protocol",
            "color": "#818cf8"
          }
        ]
      }
    },
    {
      ...
      "description": "Any object with [Symbol.iterator] returning an iterator (with .next()) is iterable.",
      "code": "// Infinite Fibonacci iterator\nconst fibonacci = {\n    [Symbol.iterator]() {\n        let [a, b] = [0, 1];\n        return {\n            next() {\n                [a, b] = [b, a + b];\n                return { value: a, done: false };\n            }\n        };\n    }\n};\nconst [f1,f2,f3,f4,f5] = fibonacci;  // 1,1,2,3,5",
      "diagram": {
        "kind": "flow",
        "steps": [
          {
            "label": "[Symbol.iterator]: entry point",
            "done": true
          },
          {
            "label": "returns iterator with .next()",
            "done": true
          },
          {
            "label": "next(): {value, done}",
            "active": true
          },
          {
    ...
    },
    {
      ...
      "description": "Override how an object converts to a primitive (number, string, or default).",
      "code": "class Temperature {\n    constructor(celsius) { this.celsius = celsius; }\n    [Symbol.toPrimitive](hint) {\n        if (hint === \"number\") return this.celsius;\n        if (hint === \"string\") return `${this.celsius}°C`;\n        return this.celsius;\n    }\n}\nconst t = new Temperature(25);\nt + 5;        // 30 (numeric)\n`${t}`;       // \"25°C\" (string)\nt > 20;       // true",
      "diagram": {
        "kind": "boxes",
        "title": "Symbol.toPrimitive hints",
        "items": [
          {
            "label": "\"number\": arithmetic context",
            "color": "#818cf8"
          },
          {
            "label": "\"string\": template literal",
            "color": "#10b981",
            "highlight": true
          },
          {
    ...
    },
    {
      ...
      "description": "Symbol.for(\"key\") returns the same Symbol every time. Cross-module shared symbols.",
      ...
      "diagram": {
        ...
        "items": [
          {
            "label": "Symbol.for: global registry",
            "color": "#10b981",
            "highlight": true
          },
          {
            "label": "same key → same Symbol",
            "color": "#10b981"
          },
          {
            "label": "Symbol(): always unique (no registry)",
            "color": "#818cf8"
          }
        ]
      }
