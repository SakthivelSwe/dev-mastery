  ...
  "steps": [
    {
      ...
      "description": "Declarations are hoisted (usable before definition). Expressions are not. Arrow functions are always expressions.",
      ...
      "diagram": {
        ...
        "items": [
          {
            "label": "function foo() {}: declaration, hoisted",
            "color": "#818cf8"
          },
          {
            "label": "const foo = function() {}: expression",
            "color": "#818cf8"
          },
          {
            "label": "const foo = () => {}: arrow, no own this",
            "color": "#10b981",
            "highlight": true
          }
        ]
    ...
    {
      "title": "Arguments and default parameters",
      "description": "Functions can have default values. Extra arguments are ignored (or captured via ...rest). Missing arguments are undefined.",
      ...
      "diagram": {
        ...
        "steps": [
          {
            "label": "no arg → use default value",
            "done": true
          },
          {
            "label": "arg provided → use it",
            "done": true
          },
          {
            "label": "extra args → captured by ...rest",
            "active": true
          }
        ]
      }
    ...
    {
      "title": "Return values",
      "description": "Functions return undefined if no return. Only one return value — bundle multiple into object/array.",
      ...
      "diagram": {
        ...
        "items": [
          {
            "label": "implicit return undefined",
            "color": "#818cf8"
          },
          {
            "label": "object destructure for named results",
            "color": "#10b981",
            "highlight": true
          },
          {
            "label": "array destructure for tuple-like",
            "color": "#818cf8"
          }
        ]
      }
    },
    {
      ...
      "description": "Functions are values. Pass them as arguments, return them, store in variables. Enables higher-order functions.",
      ...
      "diagram": {
        ...
        "messages": [
          ...
          },
          {
            "from": "multiplyBy",
            "to": "triple",
            "label": "returns closure over factor=3"
          },
          {
            "from": "caller",
            "to": "triple",
    ...
    },
    {
      ...
      "description": "Pure: same input → same output, no side effects. Prefer pure functions — easier to test, cache, and parallelize.",
      ...
      "diagram": {
        ...
        "items": [
          {
            "label": "referentially transparent",
            "color": "#10b981",
            "highlight": true
          },
          {
            "label": "easy to test (no mocks)",
            "color": "#10b981"
          },
          {
            "label": "cacheable / memoizable",
            "color": "#10b981"
          },
          {
            "label": "thread-safe by construction",
            "color": "#818cf8"
          }
        ]
      }
