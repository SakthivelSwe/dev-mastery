...
```json
{
  ...
  "steps": [
    {
      "title": "for — classic counter loop",
      "description": "Best when you need the index or a specific step. Runs setup once, checks condition, executes body, then step.",
    ...
    {
      "title": "for...of — iterate values",
      "description": "Iterates values of iterables: arrays, strings, Maps, Sets, generators. Modern default.",
      ...
      "diagram": {
        "kind": "boxes",
        "title": "for...of features",
        "items": [
          {
            "label": "works on any iterable",
            "color": "#10b981",
            "highlight": true
          },
          {
            "label": "arr.entries() for [index, value]",
            "color": "#818cf8"
          },
          {
            "label": "const inside: safe reference",
            "color": "#818cf8"
          }
        ]
      }
    ...
    {
      "title": "for...in — iterate keys (careful!)",
      "description": "for...in iterates enumerable property names. Includes inherited props! Rarely what you want — use Object.keys() or Object.entries().",
      ...
      "diagram": {
        "kind": "boxes",
        "title": "for...in pitfalls",
        "items": [
          {
            "label": "iterates enumerable KEYS not values",
            "color": "#f59e0b"
          },
          {
            "label": "includes inherited props (prototype)",
            "color": "#ef4444",
            "highlight": true
          },
          {
            "label": "prefer Object.entries + for...of",
            "color": "#10b981"
          }
        ]
      }
    },
    {
      ...
      "description": "forEach, map, filter, reduce, find, some, every. Functional, no explicit index needed. Cannot break out (use for/for-of if needed).",
      ...
      "diagram": {
        ...
        "items": [
          {
            "label": "map: transform (returns array)",
            "color": "#10b981",
            "highlight": true
          },
          {
            "label": "filter: keep matching",
            "color": "#818cf8"
          },
          {
            "label": "reduce: fold to single value",
            "color": "#818cf8"
          },
          {
            "label": "find/some/every: search + test",
            "color": "#818cf8"
          }
        ]
      }
    },
    {
      ...
      "description": "while: check condition, then body. do-while: run body, then check. Use when the number of iterations is not known.",
      ...
      "diagram": {
        ...
        "items": [
          {
            "label": "while: check first, may skip body",
            "color": "#818cf8"
          },
          {
            "label": "do-while: body runs at least once",
            "color": "#10b981",
            "highlight": true
          },
          {
            "label": "infinite loop risk if condition never false",
            "color": "#f59e0b"
          }
        ]
      }
