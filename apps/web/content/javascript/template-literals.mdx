  ...
  "steps": [
    {
      ...
      "description": "Backtick strings support embedded expressions ${...} and multiline without escape sequences.",
      ...
      "diagram": {
        ...
        "items": [
          {
            "label": "`${expression}`: any JS expression",
            "color": "#10b981",
            "highlight": true
          },
          {
            "label": "multiline: literal newlines work",
            "color": "#818cf8"
          },
          {
            "label": "vs \"\" + var + \"\" concatenation: cleaner",
            "color": "#818cf8"
          }
        ]
      }
    },
    {
      ...
      "description": "Any JS expression works inside ${}: function calls, ternary, arithmetic.",
      ...
      "diagram": {
        "kind": "boxes",
        "title": "Expressions in templates",
        "items": [
          {
            "label": "method call: ${arr.join(\",\")}",
            "color": "#818cf8"
          },
          {
          ...
          {
            "label": "complex: ${JSON.stringify(obj)}",
            "color": "#818cf8"
          }
        ]
      }
    },
    {
      ...
      "description": "A tag function receives the template parts and values separately. Used by styled-components, SQL query builders, i18n.",
        ...
        "messages": [
          {
            ...
            "to": "highlight fn",
            "label": "strings: [\"Hello \",\"you have \",\"messages.\"]"
          },
          {
            "from": "tagged template",
            "to": "highlight fn",
            "label": "values: [\"Alice\", 5]"
          },
          {
            "from": "highlight fn",
            "to": "result",
            "label": "\"Hello <b>Alice</b>...\""
          }
        ]
      }
    },
    {
      ...
      "description": "styled-components uses tagged templates to write CSS. Dynamic styles via embedded expressions.",
      ...
      "diagram": {
        ...
        "items": [
          {
            "label": "tagged template = function call",
            "color": "#818cf8"
          },
          {
            "label": "${props => ...}: dynamic CSS values",
            "color": "#10b981",
            "highlight": true
          },
          {
            "label": "generates scoped CSS class names",
            "color": "#818cf8"
          }
        ]
      }
    ...
    {
      "title": "SQL and GraphQL query builders",
      "description": "Tagged templates enforce safe parameterized queries — user input can never break SQL syntax.",
      "code": "// Safe SQL with tagged template\nconst query = sql`SELECT * FROM users WHERE id = ${userId}`;\n// Library escapes userId — no SQL injection!\n\n// GraphQL\nconst GET_USER = gql`\n    query GetUser($id: ID!) {\n        user(id: $id) { name email }\n    }\n`;",
      "diagram": {
        "kind": "flow",
        "steps": [
          {
            "label": "userId embedded as parameter, not string concat",
            "done": true
          },
          {
            "label": "library escapes / parameterizes safely",
            "done": true
          },
          {
            "label": "SQL injection impossible",
            "active": true
          }
        ]
      }
