...
{
  "language": "javascript",
  "fileName": "web-apis.js",
  "steps": [
    {
      "title": "localStorage and sessionStorage",
      "description": "localStorage: persists across sessions. sessionStorage: cleared when tab closes. Both are synchronous and string-only. ~5-10MB limit.",
      ...
      "diagram": {
        ...
        "items": [
          ...
          {
            "label": "sessionStorage: tab lifetime only",
            "color": "#818cf8"
          },
          {
            "label": "strings only — JSON.stringify for objects",
            "color": "#10b981",
            "highlight": true
          }
        ]
    ...
    },
    {
      ...
      "description": "Detect when elements enter/leave the viewport. Better than scroll listeners — native, no layout thrashing.",
      "code": "const observer = new IntersectionObserver(entries => {\n    entries.forEach(entry => {\n        if (entry.isIntersecting) {\n            entry.target.src = entry.target.dataset.src;\n            observer.unobserve(entry.target);\n        }\n    });\n}, { rootMargin: \"100px\" });\n\ndocument.querySelectorAll(\"[data-src]\").forEach(el => observer.observe(el));",
      "diagram": {
        "kind": "flow",
        "steps": [
          {
            "label": "observe lazy images",
            "done": true
          },
          {
            "label": "user scrolls → element enters viewport",
            "done": true
          },
          {
            "label": "set real src → image loads",
            "active": true
          },
          {
    ...
    {
      "title": "Clipboard API",
      "description": "Read/write clipboard programmatically. Requires permissions. Useful for copy buttons.",
      ...
      "diagram": {
        ...
        "items": [
          {
            "label": "writeText: needs user gesture",
            "color": "#818cf8"
          },
          {
            "label": "readText: needs permission prompt",
            "color": "#f59e0b",
            "highlight": true
          },
          {
            "label": "replaces legacy document.execCommand",
            "color": "#10b981"
          }
        ]
      }
    ...
    {
      "title": "Geolocation and Permission APIs",
      "description": "Request user location. Always handle errors (user denied, timeout, unavailable).",
      ...
      "diagram": {
        ...
        "steps": [
          ...
          {
            "label": "browser prompts user for permission",
            "done": true
          },
          {
            "label": "granted: callback with coords",
            "active": true
          },
          {
    ...
    },
    {
      ...
      "description": "Communicate between threads via postMessage. SharedArrayBuffer enables shared memory with Atomics for synchronization.",
      ...
      "diagram": {
        ...
        "items": [
          {
            "label": "zero-copy shared memory",
            "color": "#10b981",
            "highlight": true
          },
          {
            "label": "Atomics: safe concurrent access",
            "color": "#10b981"
          },
          {
            "label": "requires COOP/COEP headers for security",
            "color": "#f59e0b"
          }
        ]
      }
