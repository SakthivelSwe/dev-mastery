  ...
  "steps": [
    {
      ...
      "description": "Unit tests (many, fast): individual functions. Integration tests (moderate): multiple components together. E2E tests (few, slow): full browser flows.",
      ...
      "diagram": {
        ...
        "items": [
          {
            "label": "E2E: 10% — slow, full browser",
            "color": "#818cf8"
          },
          {
            "label": "Integration: 20% — services/APIs",
            "color": "#818cf8"
          },
          {
            "label": "Unit: 70% — fast, isolated",
            "color": "#10b981",
            "highlight": true
          }
        ]
    ...
    {
      "title": "Vitest / Jest basics",
      "description": "describe groups tests. test/it defines a test. expect with matchers: toBe, toEqual, toBeTruthy, toThrow, toHaveBeenCalledWith.",
      "code": "describe(\"Calculator\", () => {\n    test(\"adds two numbers\", () => {\n        expect(add(2, 3)).toBe(5);\n    });\n    test(\"throws on divide by zero\", () => {\n        expect(() => divide(1, 0)).toThrow(\"Division by zero\");\n    });\n    test(\"deep equality\", () => {\n        expect(buildUser(\"A\")).toEqual({ name:\"A\", role:\"user\" });\n    });\n});",
      "diagram": {
        "kind": "flow",
        "steps": [
          {
            "label": "describe: logical test group",
            "done": true
          },
          {
            "label": "test: assertion block",
            "done": true
          },
          {
            "label": "expect(value).matcher(): assertion",
            "active": true
          }
        ]
      }
    ...
    {
      "title": "Mocking with vi.fn / jest.fn",
      "description": "Mock functions track calls. Spy on module exports. Control return values. Restore after tests.",
      ...
      "diagram": {
        ...
        "items": [
          {
            "label": "vi.fn(): mock function",
            "color": "#818cf8"
          },
          {
            "label": ".mockResolvedValue(): async return",
            "color": "#818cf8"
          },
          {
            "label": "vi.spyOn: wrap real function",
            "color": "#10b981",
            "highlight": true
          }
        ]
    ...
    },
    {
      ...
      "description": "Return the Promise or use async/await. Use vi.useFakeTimers() for setTimeout/setInterval.",
      ...
      "diagram": {
        ...
        "items": [
          {
            "label": "async/await: await the Promise",
            "color": "#10b981",
            "highlight": true
          },
          {
            "label": "vi.useFakeTimers(): control time",
            "color": "#10b981"
          },
          {
            "label": "advanceTimersByTime: simulate elapsed",
            "color": "#818cf8"
          }
        ]
      }
    ...
    {
      "title": "Coverage and TDD",
      "description": "Code coverage: lines, branches, functions. 80% coverage is a common target. TDD: Red (fail) → Green (pass) → Refactor.",
      ...
      "diagram": {
        ...
        "steps": [
          ...
          {
            "label": "Green: minimal code to pass",
            "done": true
          },
          {
            "label": "Refactor: clean up",
            "active": true
          },
          {
