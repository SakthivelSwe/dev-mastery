  ...
  "steps": [
    {
      ...
      "description": "JavaScript runs in browsers, Node.js, Deno, and Bun. Single-threaded, event-driven, dynamically typed. Powers 98% of websites.",
      ...
      "diagram": {
        ...
        "items": [
          {
            "label": "Browsers: DOM + APIs",
            "color": "#818cf8"
          },
          {
            "label": "Node.js: server-side + libuv",
            "color": "#10b981",
            "highlight": true
          },
          {
            "label": "Deno / Bun: modern runtimes",
            "color": "#818cf8"
          }
        ]
      }
    ...
    {
      "title": "Interpreted + JIT compiled",
      "description": "V8 parses source → AST → bytecode (Ignition interpreter) → hot code paths get compiled to optimized machine code (TurboFan JIT).",
      ...
      "diagram": {
        ...
        "steps": [
          ...
          {
            "label": "hot code → TurboFan JIT compile",
            "active": true
          },
          {
    ...
    },
    {
      ...
      "description": "One main thread runs JS. I/O (network, file) is offloaded to Node.js libuv thread pool or browser APIs. Callbacks return to the event loop.",
        ...
        "messages": [
          {
            "from": "Call Stack",
            "to": "Microtask Q",
            "label": "schedule Promise.then"
          },
          {
            "from": "Call Stack",
            "to": "Macrotask Q",
            "label": "schedule setTimeout"
          },
          {
            "from": "Microtask Q",
            "to": "Call Stack",
            "label": "drain FIRST (higher priority)"
          },
          {
            "from": "Macrotask Q",
            "to": "Call Stack",
            "label": "then next macrotask"
          }
        ]
      }
    },
    {
      ...
      "description": "ECMAScript is the spec; JavaScript is the implementation. New features: ES6 (2015), ES7-ES15 (2016-2024). Modern browsers support ES2020+.",
      ...
      "diagram": {
        "kind": "boxes",
        "title": "ES6+ highlights",
        "items": [
          {
            "label": "let/const, arrow, template literals",
            "color": "#818cf8"
          },
          {
            "label": "classes, destructuring, spread/rest",
            "color": "#818cf8"
          },
          {
            "label": "modules, Promise, async/await",
            "color": "#10b981",
            "highlight": true
          },
          {
            "label": "Optional chaining ?. (ES2020)",
            "color": "#818cf8"
          }
        ]
      }
    },
    {
      ...
      "description": "npm has 3M+ packages. Bundlers (Vite, esbuild), transpilers (Babel, TypeScript), frameworks (React, Vue, Angular), runtimes (Node, Bun).",
      "code": "// package.json\n{\n  \"dependencies\": {\n    \"react\": \"^19.0.0\",\n    \"next\": \"^15.0.0\"\n  },\n  \"devDependencies\": {\n    \"typescript\": \"^5.7.0\",\n    \"vite\": \"^6.0.0\"\n  }\n}",
      "diagram": {
        "kind": "boxes",
        "title": "JS toolchain",
        "items": [
          {
            "label": "npm/pnpm/yarn: package management",
            "color": "#818cf8"
          },
          {
            "label": "Vite / esbuild: bundle + serve",
            "color": "#10b981",
            "highlight": true
          },
          {
            "label": "TypeScript / Babel: transpile",
            "color": "#818cf8"
          },
          {
            "label": "ESLint / Prettier: quality",
            "color": "#818cf8"
          }
        ]
      }
