...
```json
{
  ...
  "steps": [
    {
      "title": "Generic types",
      "description": "Generics create reusable, type-safe components that work across many types. The type parameter acts as a variable for types.",
        ...
        "items": [
          {
            ...
            "color": "#10b981",
            "value": "Repository<T>: works for any entity",
            "highlight": true
          },
          {
            "label": "Generic class",
            "color": "#818cf8",
            "value": "Stack<T>: typed push/pop"
          },
          {
            "label": "Type parameter <T>",
            "color": "#f59e0b",
            "value": "Replaced with actual type at usage"
          },
          {
            "label": "Multiple params",
            "color": "#60a5fa",
            "value": "<K, V> for key-value structures"
          }
        ]
      }
    },
    {
      ...
      "description": "Constraints (extends) restrict what types can be used as type parameters. This enables accessing properties on the type parameter.",
      ...
      "diagram": {
        ...
        "steps": [
          {
            "label": "T extends { id: string } — must have id",
            "done": true
          },
          {
            "label": "K extends keyof T — K must be valid key",
            "done": true
          },
          {
            "label": "T[K] — type at that key (indexed access)",
            "active": true
          },
          {
    ...
    },
    {
      ...
      "description": "Type parameters can have defaults, used when the type is not explicitly provided or cannot be inferred.",
      ...
      "diagram": {
        ...
        "items": [
          {
            "label": "Default type: T = unknown",
            "color": "#10b981",
            "value": "Used when T not provided",
            "highlight": true
          },
          {
            "label": "Explicit override",
            "color": "#818cf8",
            "value": "ApiResponse<User> overrides default"
          },
          {
            "label": "Constraint + default",
            "color": "#f59e0b",
            "value": "T extends string = string"
          },
          {
            "label": "Inference wins",
            "color": "#60a5fa",
            "value": "Inferred type takes priority over default"
          }
        ]
      }
    },
    {
      ...
      "description": "Conditional types choose a type based on a condition: T extends U ? X : Y. They enable advanced type logic.",
      ...
      "diagram": {
        "kind": "boxes",
        "title": "Conditional type uses",
        "items": [
          {
            "label": "T extends U ? X : Y",
            "color": "#10b981",
            "value": "Branch on type relationship",
            "highlight": true
          },
          {
            "label": "infer R",
            "color": "#818cf8",
            "value": "Extract/capture a type from conditional"
          },
          {
            "label": "Distributive",
            "color": "#f59e0b",
            "value": "Applied to each union member individually"
          },
          {
            "label": "never filters",
            "color": "#60a5fa",
            "value": "T | never = T (filter out never)"
          }
        ]
      }
    },
    {
      "title": "Utility types using generics",
      "description": "TypeScript's built-in utility types (Partial, Required, Pick, Omit, Record, ReturnType) are all implemented using generic type manipulation.",
        ...
        "items": [
          {
            "label": "Partial<T>",
            "color": "#10b981",
            "value": "All properties optional",
            "highlight": true
          },
          {
            "label": "Pick<T, K>",
            "color": "#818cf8",
            "value": "Only specified properties"
          },
          {
            "label": "Omit<T, K>",
            "color": "#f59e0b",
            "value": "All except specified properties"
          },
          {
            "label": "ReturnType<F>",
            "color": "#60a5fa",
            "value": "Return type of a function"
          }
        ]
      }
    }
