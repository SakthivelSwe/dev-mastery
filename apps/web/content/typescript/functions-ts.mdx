  ...
  "steps": [
    {
      ...
      "description": "TypeScript functions can have typed parameters, return types, and support optional and default parameters.",
        ...
        "items": [
          {
            ...
            "color": "#10b981",
            "value": "Must be provided, position matters",
            "highlight": true
          },
          {
            "label": "Optional (name?: T)",
            "color": "#818cf8",
            "value": "May be undefined"
          },
          {
            "label": "Default (name = val)",
            "color": "#f59e0b",
            "value": "Uses default if not provided"
          },
          {
            "label": "Rest (...args: T[])",
            "color": "#60a5fa",
            "value": "Any number of params as array"
          }
        ]
      }
    },
    {
      ...
      "description": "Function overloads allow a function to have different signatures for different input types. TypeScript checks against overload signatures, not the implementation.",
      ...
      "diagram": {
        ...
        "steps": [
          {
            "label": "Declare overload signatures (lines 2-4)",
            "done": true
          },
          {
            "label": "Implement all cases in one function (line 7)",
            "done": true
          },
          {
            "label": "TypeScript checks callers against overloads",
            "active": true
          },
          {
    ...
    },
    {
      ...
      "description": "Generic functions work with any type while preserving type information. The type parameter <T> is inferred from the arguments.",
        ...
        "items": [
          {
            "label": "<T>",
            "color": "#10b981",
            "value": "Any type — inferred from argument",
            "highlight": true
          },
          {
            "label": "<T extends Type>",
            "color": "#818cf8",
            "value": "T must have at least those properties"
          },
          {
            "label": "<T extends keyof U>",
            "color": "#f59e0b",
            "value": "T must be a key of type U"
          },
          {
            "label": "Inferred vs explicit",
            "color": "#60a5fa",
            "value": "fn(42) vs fn<number>(42)"
          }
        ]
      }
    },
    {
      ...
      "description": "TypeScript types higher-order functions cleanly. The type of a function-taking-function is expressed using function type syntax.",
      ...
      "diagram": {
        "kind": "boxes",
        "title": "HOF type patterns",
        "items": [
          {
            "label": "(item: T) => boolean",
            "color": "#10b981",
            "value": "Predicate function type",
            "highlight": true
          },
          {
            "label": "(acc: R, item: T) => R",
            "color": "#818cf8",
            "value": "Reducer function type"
          },
          {
            "label": "() => () => T",
            "color": "#f59e0b",
            "value": "Function that returns a function"
          },
          {
            "label": "Type aliases",
            "color": "#60a5fa",
            "value": "Name complex function types for reuse"
          }
        ]
      }
    },
    {
      "title": "void, never, and this",
      "description": "void: function returns nothing. never: function never returns (throws or infinite loop). this: type of the current object context.",
        ...
        "items": [
          {
            "label": "void",
            "color": "#10b981",
            "value": "Function produces no value",
            "highlight": true
          },
          {
            "label": "never",
            "color": "#ef4444",
            "value": "Unreachable code after this function"
          },
          {
            "label": "undefined",
            "color": "#818cf8",
            "value": "Explicitly returns undefined"
          },
          {
            "label": "this parameter",
            "color": "#f59e0b",
            "value": "Type the calling context"
          }
        ]
      }
    }
