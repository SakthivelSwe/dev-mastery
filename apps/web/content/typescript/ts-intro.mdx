  ...
  "steps": [
    {
      ...
      "description": "TypeScript is a superset of JavaScript that adds static types. Every valid JS file is valid TS. Types are erased at compile time — the output is plain JS.",
      ...
      "diagram": {
        ...
        "steps": [
          {
            "label": "TypeScript source (.ts)",
            "done": true
          },
          {
            "label": "tsc: type check + transpile",
            "done": true
          },
          {
            "label": "JavaScript output (.js) — no types",
            "active": true
          },
          {
    ...
    },
    {
      ...
      "description": "TypeScript infers types from context — you don't need to annotate everything. The compiler is smart enough to figure out types from assignments and return values.",
      ...
      "diagram": {
        ...
        "items": [
          ...
          },
          {
            "label": "Return types",
            "color": "#f59e0b",
            "value": "Inferred from return expression"
          },
          {
            "label": "Best common type",
            "color": "#60a5fa",
            "value": "[1, \"a\"] → (number | string)[]"
          }
        ]
      }
    },
    {
      ...
      "description": "Explicit annotations use colon syntax: variable: Type. Function parameters and return types are annotated separately.",
        ...
        "items": [
          {
            "label": "let x: number",
            "color": "#10b981",
            "value": "Variable type annotation",
            "highlight": true
          },
          {
            "label": "fn(a: T): R",
            "color": "#818cf8",
            "value": "Parameter + return type"
          },
          {
            "label": "string[]",
            "color": "#f59e0b",
            "value": "Array type (= Array<string>)"
          },
          {
            "label": "[string, number]",
            "color": "#60a5fa",
            "value": "Tuple: fixed length, fixed types"
          }
        ]
      }
    },
    {
      ...
      "description": "tsconfig.json controls TypeScript behavior. Key options: strict (enable all strict checks), target (ES version output), module (CommonJS/ESM), paths (module aliases).",
        ...
        "items": [
          {
            "label": "strict: true",
            "color": "#ef4444",
            "value": "Enables strictNullChecks, noImplicitAny, etc",
            "highlight": true
          },
          {
            "label": "target",
            "color": "#10b981",
            "value": "ES5/ES2017/ES2022 — output syntax"
          },
          {
            "label": "moduleResolution",
            "color": "#818cf8",
            "value": "node/bundler/node16"
          },
          {
            "label": "paths",
            "color": "#f59e0b",
            "value": "Import aliases: @/utils → ./src/utils"
          }
        ]
      }
    },
    {
      "title": "TypeScript vs JavaScript — when to use",
      "description": "TypeScript shines in large codebases, teams, and long-lived projects. It catches errors at compile time, provides IDE autocomplete, and serves as documentation.",
      ...
      "diagram": {
        ...
        "steps": [
          {
            "label": "Write TypeScript with types",
            "done": true
          },
          {
            "label": "IDE: instant autocomplete + error squiggles",
            "done": true
          },
          {
            "label": "tsc: compile-time type checking",
            "active": true
          },
          {
